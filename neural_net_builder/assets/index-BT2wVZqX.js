 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vm;function Pv(){if(vm)return ht;vm=1;var a=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),l=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),f=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),x=Symbol.iterator;function v(T){return T===null||typeof T!="object"?null:(T=x&&T[x]||T["@@iterator"],typeof T=="function"?T:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},O=Object.assign,D={};function _(T,q,Q){this.props=T,this.context=q,this.refs=D,this.updater=Q||M}_.prototype.isReactComponent={},_.prototype.setState=function(T,q){if(typeof T!="object"&&typeof T!="function"&&T!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,T,q,"setState")},_.prototype.forceUpdate=function(T){this.updater.enqueueForceUpdate(this,T,"forceUpdate")};function U(){}U.prototype=_.prototype;function L(T,q,Q){this.props=T,this.context=q,this.refs=D,this.updater=Q||M}var V=L.prototype=new U;V.constructor=L,O(V,_.prototype),V.isPureReactComponent=!0;var $=Array.isArray,P={H:null,A:null,T:null,S:null,V:null},W=Object.prototype.hasOwnProperty;function J(T,q,Q,K,tt,st){return Q=st.ref,{$$typeof:a,type:T,key:q,ref:Q!==void 0?Q:null,props:st}}function X(T,q){return J(T.type,q,void 0,void 0,void 0,T.props)}function lt(T){return typeof T=="object"&&T!==null&&T.$$typeof===a}function dt(T){var q={"=":"=0",":":"=2"};return"$"+T.replace(/[=:]/g,function(Q){return q[Q]})}var Mt=/\/+/g;function Ut(T,q){return typeof T=="object"&&T!==null&&T.key!=null?dt(""+T.key):q.toString(36)}function Kt(){}function qt(T){switch(T.status){case"fulfilled":return T.value;case"rejected":throw T.reason;default:switch(typeof T.status=="string"?T.then(Kt,Kt):(T.status="pending",T.then(function(q){T.status==="pending"&&(T.status="fulfilled",T.value=q)},function(q){T.status==="pending"&&(T.status="rejected",T.reason=q)})),T.status){case"fulfilled":return T.value;case"rejected":throw T.reason}}throw T}function Tt(T,q,Q,K,tt){var st=typeof T;(st==="undefined"||st==="boolean")&&(T=null);var at=!1;if(T===null)at=!0;else switch(st){case"bigint":case"string":case"number":at=!0;break;case"object":switch(T.$$typeof){case a:case i:at=!0;break;case y:return at=T._init,Tt(at(T._payload),q,Q,K,tt)}}if(at)return tt=tt(T),at=K===""?"."+Ut(T,0):K,$(tt)?(Q="",at!=null&&(Q=at.replace(Mt,"$&/")+"/"),Tt(tt,q,Q,"",function(mt){return mt})):tt!=null&&(lt(tt)&&(tt=X(tt,Q+(tt.key==null||T&&T.key===tt.key?"":(""+tt.key).replace(Mt,"$&/")+"/")+at)),q.push(tt)),1;at=0;var Bt=K===""?".":K+":";if($(T))for(var I=0;I<T.length;I++)K=T[I],st=Bt+Ut(K,I),at+=Tt(K,q,Q,st,tt);else if(I=v(T),typeof I=="function")for(T=I.call(T),I=0;!(K=T.next()).done;)K=K.value,st=Bt+Ut(K,I++),at+=Tt(K,q,Q,st,tt);else if(st==="object"){if(typeof T.then=="function")return Tt(qt(T),q,Q,K,tt);throw q=String(T),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(T).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.")}return at}function N(T,q,Q){if(T==null)return T;var K=[],tt=0;return Tt(T,K,"","",function(st){return q.call(Q,st,tt++)}),K}function Z(T){if(T._status===-1){var q=T._result;q=q(),q.then(function(Q){(T._status===0||T._status===-1)&&(T._status=1,T._result=Q)},function(Q){(T._status===0||T._status===-1)&&(T._status=2,T._result=Q)}),T._status===-1&&(T._status=0,T._result=q)}if(T._status===1)return T._result.default;throw T._result}var et=typeof reportError=="function"?reportError:function(T){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof T=="object"&&T!==null&&typeof T.message=="string"?String(T.message):String(T),error:T});if(!window.dispatchEvent(q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",T);return}console.error(T)};function gt(){}return ht.Children={map:N,forEach:function(T,q,Q){N(T,function(){q.apply(this,arguments)},Q)},count:function(T){var q=0;return N(T,function(){q++}),q},toArray:function(T){return N(T,function(q){return q})||[]},only:function(T){if(!lt(T))throw Error("React.Children.only expected to receive a single React element child.");return T}},ht.Component=_,ht.Fragment=l,ht.Profiler=c,ht.PureComponent=L,ht.StrictMode=s,ht.Suspense=p,ht.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,ht.__COMPILER_RUNTIME={__proto__:null,c:function(T){return P.H.useMemoCache(T)}},ht.cache=function(T){return function(){return T.apply(null,arguments)}},ht.cloneElement=function(T,q,Q){if(T==null)throw Error("The argument must be a React element, but you passed "+T+".");var K=O({},T.props),tt=T.key,st=void 0;if(q!=null)for(at in q.ref!==void 0&&(st=void 0),q.key!==void 0&&(tt=""+q.key),q)!W.call(q,at)||at==="key"||at==="__self"||at==="__source"||at==="ref"&&q.ref===void 0||(K[at]=q[at]);var at=arguments.length-2;if(at===1)K.children=Q;else if(1<at){for(var Bt=Array(at),I=0;I<at;I++)Bt[I]=arguments[I+2];K.children=Bt}return J(T.type,tt,void 0,void 0,st,K)},ht.createContext=function(T){return T={$$typeof:f,_currentValue:T,_currentValue2:T,_threadCount:0,Provider:null,Consumer:null},T.Provider=T,T.Consumer={$$typeof:d,_context:T},T},ht.createElement=function(T,q,Q){var K,tt={},st=null;if(q!=null)for(K in q.key!==void 0&&(st=""+q.key),q)W.call(q,K)&&K!=="key"&&K!=="__self"&&K!=="__source"&&(tt[K]=q[K]);var at=arguments.length-2;if(at===1)tt.children=Q;else if(1<at){for(var Bt=Array(at),I=0;I<at;I++)Bt[I]=arguments[I+2];tt.children=Bt}if(T&&T.defaultProps)for(K in at=T.defaultProps,at)tt[K]===void 0&&(tt[K]=at[K]);return J(T,st,void 0,void 0,null,tt)},ht.createRef=function(){return{current:null}},ht.forwardRef=function(T){return{$$typeof:g,render:T}},ht.isValidElement=lt,ht.lazy=function(T){return{$$typeof:y,_payload:{_status:-1,_result:T},_init:Z}},ht.memo=function(T,q){return{$$typeof:h,type:T,compare:q===void 0?null:q}},ht.startTransition=function(T){var q=P.T,Q={};P.T=Q;try{var K=T(),tt=P.S;tt!==null&&tt(Q,K),typeof K=="object"&&K!==null&&typeof K.then=="function"&&K.then(gt,et)}catch(st){et(st)}finally{P.T=q}},ht.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},ht.use=function(T){return P.H.use(T)},ht.useActionState=function(T,q,Q){return P.H.useActionState(T,q,Q)},ht.useCallback=function(T,q){return P.H.useCallback(T,q)},ht.useContext=function(T){return P.H.useContext(T)},ht.useDebugValue=function(){},ht.useDeferredValue=function(T,q){return P.H.useDeferredValue(T,q)},ht.useEffect=function(T,q,Q){var K=P.H;if(typeof Q=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return K.useEffect(T,q)},ht.useId=function(){return P.H.useId()},ht.useImperativeHandle=function(T,q,Q){return P.H.useImperativeHandle(T,q,Q)},ht.useInsertionEffect=function(T,q){return P.H.useInsertionEffect(T,q)},ht.useLayoutEffect=function(T,q){return P.H.useLayoutEffect(T,q)},ht.useMemo=function(T,q){return P.H.useMemo(T,q)},ht.useOptimistic=function(T,q){return P.H.useOptimistic(T,q)},ht.useReducer=function(T,q,Q){return P.H.useReducer(T,q,Q)},ht.useRef=function(T){return P.H.useRef(T)},ht.useState=function(T){return P.H.useState(T)},ht.useSyncExternalStore=function(T,q,Q){return P.H.useSyncExternalStore(T,q,Q)},ht.useTransition=function(){return P.H.useTransition()},ht.version="19.1.0",ht}var xm;function Wc(){return xm||(xm=1,fc.exports=Pv()),fc.exports}var G=Wc();const wt=Lv(G);var dc={exports:{}},Go={},hc={exports:{}},mc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Sm;function Yv(){return Sm||(Sm=1,function(a){function i(N,Z){var et=N.length;N.push(Z);t:for(;0<et;){var gt=et-1>>>1,T=N[gt];if(0<c(T,Z))N[gt]=Z,N[et]=T,et=gt;else break t}}function l(N){return N.length===0?null:N[0]}function s(N){if(N.length===0)return null;var Z=N[0],et=N.pop();if(et!==Z){N[0]=et;t:for(var gt=0,T=N.length,q=T>>>1;gt<q;){var Q=2*(gt+1)-1,K=N[Q],tt=Q+1,st=N[tt];if(0>c(K,et))tt<T&&0>c(st,K)?(N[gt]=st,N[tt]=et,gt=tt):(N[gt]=K,N[Q]=et,gt=Q);else if(tt<T&&0>c(st,et))N[gt]=st,N[tt]=et,gt=tt;else break t}}return Z}function c(N,Z){var et=N.sortIndex-Z.sortIndex;return et!==0?et:N.id-Z.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var f=Date,g=f.now();a.unstable_now=function(){return f.now()-g}}var p=[],h=[],y=1,x=null,v=3,M=!1,O=!1,D=!1,_=!1,U=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,V=typeof setImmediate<"u"?setImmediate:null;function $(N){for(var Z=l(h);Z!==null;){if(Z.callback===null)s(h);else if(Z.startTime<=N)s(h),Z.sortIndex=Z.expirationTime,i(p,Z);else break;Z=l(h)}}function P(N){if(D=!1,$(N),!O)if(l(p)!==null)O=!0,W||(W=!0,Ut());else{var Z=l(h);Z!==null&&Tt(P,Z.startTime-N)}}var W=!1,J=-1,X=5,lt=-1;function dt(){return _?!0:!(a.unstable_now()-lt<X)}function Mt(){if(_=!1,W){var N=a.unstable_now();lt=N;var Z=!0;try{t:{O=!1,D&&(D=!1,L(J),J=-1),M=!0;var et=v;try{e:{for($(N),x=l(p);x!==null&&!(x.expirationTime>N&&dt());){var gt=x.callback;if(typeof gt=="function"){x.callback=null,v=x.priorityLevel;var T=gt(x.expirationTime<=N);if(N=a.unstable_now(),typeof T=="function"){x.callback=T,$(N),Z=!0;break e}x===l(p)&&s(p),$(N)}else s(p);x=l(p)}if(x!==null)Z=!0;else{var q=l(h);q!==null&&Tt(P,q.startTime-N),Z=!1}}break t}finally{x=null,v=et,M=!1}Z=void 0}}finally{Z?Ut():W=!1}}}var Ut;if(typeof V=="function")Ut=function(){V(Mt)};else if(typeof MessageChannel<"u"){var Kt=new MessageChannel,qt=Kt.port2;Kt.port1.onmessage=Mt,Ut=function(){qt.postMessage(null)}}else Ut=function(){U(Mt,0)};function Tt(N,Z){J=U(function(){N(a.unstable_now())},Z)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(N){N.callback=null},a.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<N?Math.floor(1e3/N):5},a.unstable_getCurrentPriorityLevel=function(){return v},a.unstable_next=function(N){switch(v){case 1:case 2:case 3:var Z=3;break;default:Z=v}var et=v;v=Z;try{return N()}finally{v=et}},a.unstable_requestPaint=function(){_=!0},a.unstable_runWithPriority=function(N,Z){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var et=v;v=N;try{return Z()}finally{v=et}},a.unstable_scheduleCallback=function(N,Z,et){var gt=a.unstable_now();switch(typeof et=="object"&&et!==null?(et=et.delay,et=typeof et=="number"&&0<et?gt+et:gt):et=gt,N){case 1:var T=-1;break;case 2:T=250;break;case 5:T=1073741823;break;case 4:T=1e4;break;default:T=5e3}return T=et+T,N={id:y++,callback:Z,priorityLevel:N,startTime:et,expirationTime:T,sortIndex:-1},et>gt?(N.sortIndex=et,i(h,N),l(p)===null&&N===l(h)&&(D?(L(J),J=-1):D=!0,Tt(P,et-gt))):(N.sortIndex=T,i(p,N),O||M||(O=!0,W||(W=!0,Ut()))),N},a.unstable_shouldYield=dt,a.unstable_wrapCallback=function(N){var Z=v;return function(){var et=v;v=Z;try{return N.apply(this,arguments)}finally{v=et}}}}(mc)),mc}var Tm;function Xv(){return Tm||(Tm=1,hc.exports=Yv()),hc.exports}var pc={exports:{}},Te={};/**
 * @license React
...
}`);Array.from({length:4},function(a,i){return"--life-line-phase".concat(i+1,"-color")});const $S=({startX:a,startY:i,endX:l,endY:s})=>H.jsx(pe.line,{x1:a,y1:i,x2:l,y2:s,className:"active-connection",markerEnd:"url(#arrowhead)",initial:{opacity:0},animate:{opacity:1},transition:{duration:.2}}),WS=({connection:a,neurons:i,neuronRadius:l,neuronTransforms:s,isGlowing:c,emphasizedConnections:d,showForwardPassVisuals:f,inputData:g,currentSampleIndex:p,neuronHeaders:h,hiddenWeights:y,inputNeurons:x,hiddenNeurons:v,hiddenBiases:M,outputWeights:O,outputBiases:D,showSigmoidPhase:_,outputNeurons:U})=>{const L=i.find(Q=>Q.id===a.fromNeuronId),V=i.find(Q=>Q.id===a.toNeuronId);if(!L||!V)return null;const $=d.includes(a.id),P=f?$?1:.3:1,W=s[a.fromNeuronId]||{x:0,y:0},J=s[a.toNeuronId]||{x:0,y:0},X=L.x+W.x,lt=L.y+W.y,dt=V.x+J.x,Mt=V.y+J.y,Ut=(Q,K,tt,st)=>{switch(K){case"top":return{x:tt,y:st-l};case"right":return{x:tt+l,y:st};case"bottom":return{x:tt,y:st+l};case"left":return{x:tt-l,y:st};default:return{x:tt,y:st}}},Kt=Ut(L,a.fromDirection,X,lt),qt=Ut(V,a.toDirection,dt,Mt),Tt=(Kt.x+qt.x)/2;let N=(Kt.y+qt.y)/2;const Z=Math.atan2(qt.y-Kt.y,qt.x-Kt.x)*(180/Math.PI),et=()=>{if(!f||!g[p]||!d.includes(a.id))return null;const Q=h[L.label]||L.label,K=h[V.label]||V.label;if(L.type==="input"&&V.type==="hidden"){const tt=parseFloat(g[p][Q])||0,st=y[`${Q}-${K}`]||0,at=M[K]||0,Bt=tt*st+at;return`${tt} × ${st.toFixed(1)} + ${at.toFixed(1)} = ${Bt.toFixed(1)}`}if(L.type==="hidden"&&V.type==="output"){let tt=0;x.forEach(Ct=>{const Xt=h[Ct.label]||Ct.label,Pt=parseFloat(g[p][Xt])||0,ce=y[`${Xt}-${Q}`]||0;tt+=Pt*ce});const st=M[Q]||0,at=tt+st,Bt=Math.max(0,at),I=O[`${Q}-${K}`]||0,mt=D[K]||0,At=(Bt*I+mt).toFixed(1);return`${Bt.toFixed(0)} × ${I.toFixed(1)} + ${mt.toFixed(1)} = ${At}`}return L.type==="output"&&V.type==="display"&&a.isSigmoidConnection,null},gt=()=>{if(!(L.type==="output"&&V.type==="display"&&a.isSigmoidConnection))return null;N-=20;const Q=h[L.label]||L.label;let K=0;v.forEach(at=>{const Bt=h[at.label]||at.label;let I=0;x.forEach(Pt=>{const ce=h[Pt.label]||Pt.label,rn=parseFloat(g[p][ce])||0,Ge=y[`${ce}-${Bt}`]||0;I+=rn*Ge});const mt=M[Bt]||0,At=I+mt,Ct=Math.max(0,At),Xt=O[`${Bt}-${Q}`]||0;K+=Ct*Xt});const tt=D[Q]||0;K+=tt;const st=K.toFixed(1);return H.jsxs("g",{children:[H.jsx("line",{x1:Tt-25,y1:N-5,x2:Tt+25,y2:N-5,stroke:"#ffffff",strokeWidth:"1"}),H.jsx("text",{x:Tt,y:N-10,fill:"#ffffff",fontSize:"12px",textAnchor:"middle",children:"1"}),H.jsx("text",{x:Tt-10,y:N+10,fill:"#ffffff",fontSize:"12px",textAnchor:"middle",children:"1 + e"}),H.jsxs("text",{x:Tt+8,y:N+5,fill:"#ffffff",fontSize:"8px",textAnchor:"start",children:["-",st]})]})},T=et(),q=a.isAnimating?"active-connection":c?"completed-connection glowing-connection":"completed-connection";return H.jsxs("g",{children:[H.jsx(pe.line,{x1:Kt.x,y1:Kt.y,x2:qt.x,y2:qt.y,className:q,markerEnd:a.isAnimating?void 0:"url(#arrowhead)",initial:a.isAnimating?{pathLength:0}:{pathLength:1,opacity:P},animate:a.isAnimating?{pathLength:1}:{pathLength:1,opacity:P},transition:a.isAnimating?{duration:.6,ease:"easeInOut"}:{duration:.2}}),T&&H.jsx(pe.text,{x:Tt,y:N-8,className:"formula-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.5,duration:.5},style:{fontSize:"11px",fill:"#ffffff",textAnchor:"middle",pointerEvents:"none"},transform:`rotate(${Z}, ${Tt}, ${N-8})`,children:T}),d.includes(a.id)&&H.jsx(pe.g,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.5,duration:.5},children:gt()})]})},IS=({x:a,y:i,neuronId:l,direction:s,onStartConnection:c,isHighlighted:d=!1})=>H.jsx(pe.circle,{cx:a,cy:i,r:4,className:`connection-dot ${d?"connection-dot-highlighted":""}`,onClick:f=>{f.stopPropagation(),c(l,s,a,i,f)},whileHover:{scale:1.2},initial:{scale:0},animate:{scale:1},exit:{scale:0},transition:{duration:.2},style:{cursor:"pointer"}}),tT=({id:a,x:i,y:l,radius:s,label:c,type:d,onDragEnd:f,onStartConnection:g,highlightedDots:p=[],onDragUpdate:h,isGlowing:y,neurons:x,showForwardPassVisuals:v,emphasizedConnections:M,hiddenNeurons:O,inputNeurons:D,outputNeurons:_,neuronHeaders:U,hiddenWeights:L,outputWeights:V,inputData:$,currentSampleIndex:P,hiddenBiases:W,connections:J,showSigmoidPhase:X,outputBiases:lt})=>{const[dt,Mt]=G.useState(!1),[Ut,Kt]=G.useState(!1),qt=x.find(I=>I.id===a),Tt=v&&(qt?.type==="input"||qt?.type==="hidden"&&J.some(I=>M.includes(I.id)&&(I.fromNeuronId===a||I.toNeuronId===a))||qt?.type==="output"&&(M.some(I=>{const mt=J.find(At=>At.id===I);return mt&&mt.toNeuronId===a})||X)||qt?.type==="display"),N=v&&!Tt?.3:1,Z=I=>{const mt="neuron",At=I==="input"?"neuron-input":I==="hidden"?"neuron-hidden":I==="output"?"neuron-output":I.startsWith("hidden")?"neuron-hidden":"neuron";return y?`${mt} ${At} glowing-neuron`:`${mt} ${At}`},gt=(I=>{const mt=U[I.label]||I.label,At=[];return I.type==="hidden"?D.forEach(Ct=>{const Xt=U[Ct.label]||Ct.label,Pt=L[`${Xt}-${mt}`]||0;At.push(Pt)}):I.type==="output"&&O.forEach(Ct=>{const Xt=U[Ct.label]||Ct.label,Pt=V[`${Xt}-${mt}`]||0;At.push(Pt)}),At})(qt||{type:d,label:c}),T=gt.length>0?`[${gt.map(I=>I.toFixed(1)).join(", ")}]`:"",q=()=>{if(d==="input"&&v&&$[P]){const I=U[c]||c;return $[P][I]||""}return""},Q=()=>{if(d==="hidden"&&v&&$[P]){const I=U[c]||c;if(J.some(At=>M.includes(At.id)&&At.toNeuronId===a&&D.some(Ct=>Ct.id===At.fromNeuronId))){let At=0;D.forEach(Pt=>{const ce=U[Pt.label]||Pt.label,rn=parseFloat($[P][ce])||0,Ge=L[`${ce}-${I}`]||0;At+=rn*Ge});const Ct=W[I]||0;return(At+Ct).toFixed(1)}}return""},K=()=>{if(d==="output"&&v&&X&&$[P]){const I=U[c]||c,mt=[];O.forEach(Ct=>{const Xt=U[Ct.label]||Ct.label;let Pt=0;D.forEach(sn=>{const Rn=U[sn.label]||sn.label,Ze=parseFloat($[P][Rn])||0,Kn=L[`${Rn}-${Xt}`]||0;Pt+=Ze*Kn});const ce=W[Xt]||0,rn=Pt+ce,Ge=Math.max(0,rn),ge=V[`${Xt}-${I}`]||0,Aa=Ge*ge;mt.push(Aa.toFixed(1))});const At=lt[I]||0;return`${mt.join(" + ")} + ${At.toFixed(1)}`}return""},tt=()=>{if(d==="output"&&v&&X&&$[P]){const I=U[c]||c;let mt=0;O.forEach(Ct=>{const Xt=U[Ct.label]||Ct.label;let Pt=0;D.forEach(Aa=>{const sn=U[Aa.label]||Aa.label,Rn=parseFloat($[P][sn])||0,Ze=L[`${sn}-${Xt}`]||0;Pt+=Rn*Ze});const ce=W[Xt]||0,rn=Pt+ce,Ge=Math.max(0,rn),ge=V[`${Xt}-${I}`]||0;mt+=Ge*ge});const At=lt[I]||0;return mt+=At,mt.toFixed(1)}return""},st=[{direction:"top",x:0,y:-s},{direction:"right",x:s,y:0},{direction:"bottom",x:0,y:s},{direction:"left",x:-s,y:0}],at=()=>{dt||Kt(!0)},Bt=()=>{Kt(!1)};return H.jsxs(pe.g,{drag:!0,dragMomentum:!1,dragElastic:.1,initial:{x:i,y:l},animate:{x:i,y:l,opacity:N},onDragStart:()=>{Mt(!0),Kt(!1)},onDrag:(I,mt)=>{h(a,mt.offset.x,mt.offset.y)},onDragEnd:(I,mt)=>{Mt(!1);const At=i+mt.offset.x,Ct=l+mt.offset.y;f(a,At,Ct),h(a,0,0)},whileDrag:{scale:1.1},onMouseEnter:at,onMouseLeave:Bt,style:{cursor:dt?"grabbing":"default"},children:[H.jsx("circle",{cx:0,cy:0,r:s+20,fill:"transparent",style:{pointerEvents:"all",cursor:"default"}}),H.jsx(pe.circle,{cx:0,cy:0,r:s,className:Z(d),initial:{scale:0,opacity:0},animate:{scale:1,opacity:1},transition:{duration:.6,type:"spring"},style:{cursor:dt?"grabbing":"grab"},onClick:I=>{I.button}}),(Q()||d==="output"&&X)&&H.jsx("rect",{x:-23,y:-9,width:46,height:18,rx:3,fill:"rgb(6, 129, 0)",stroke:"#22c55e",strokeWidth:2}),H.jsx(pe.text,{x:0,y:5,className:"neuron-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.3,duration:.5},style:{pointerEvents:"none"},children:Q()?"ReLU":d==="output"&&X?"Sig":c}),T&&!(d==="output"&&X)&&H.jsx(pe.text,{x:0,y:-s-10,className:Q()?"neuron-text":"neuron-weights-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.5,duration:.5},style:{},children:Q()||T}),d==="output"&&X&&K()&&H.jsx(pe.text,{x:0,y:-s-25,className:"formula-text",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.5},style:{fontSize:"11px",fill:"#ffffff",textAnchor:"middle",pointerEvents:"none"},children:K()}),d==="output"&&X&&tt()&&H.jsx(pe.text,{x:0,y:-s-10,className:"neuron-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:3.5,duration:.5},style:{pointerEvents:"none"},children:tt()}),d==="input"&&v&&q()&&H.jsx(pe.text,{x:0,y:-s*1.3,className:"input-value-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.3,duration:.5},style:{pointerEvents:"none",fontSize:"14px",fill:"#ffffff",textAnchor:"middle"},children:q()}),H.jsx(F2,{children:Ut&&!dt&&st.map(I=>H.jsx(IS,{x:I.x,y:I.y,neuronId:a,direction:I.direction,onStartConnection:g,isHighlighted:p.includes(I.direction)},I.direction))})]})},Zp=(a,i)=>{const l=a.length,s=a[0].length,c=i[0].length,d=Array(l).fill().map(()=>Array(c).fill(0));for(let f=0;f<l;f++)for(let g=0;g<c;g++)for(let p=0;p<s;p++)d[f][g]+=a[f][p]*i[p][g];return d},Qp=(a,i)=>a.map(l=>l.map((s,c)=>s+(i[c]||0))),eT=a=>a.map(i=>i.map(l=>Math.max(0,l))),nT=a=>a.map(i=>i.map(l=>1/(1+Math.exp(-l)))),aT=(a,i)=>a.map((s,c)=>{const d=Math.max(1e-15,Math.min(.999999999999999,i[c]));return-(s*Math.log(d)+(1-s)*Math.log(1-d))}),iT=(a,i,l,s,c,d,f,g,p,h)=>{const y=a.filter(x=>{const v=i.some(O=>x[O.label]&&x[O.label].trim()!==""),M=x.Truth!==void 0&&x.Truth!=="";return v&&M});if(y.length===0){alert("Please add input data with truth values");return}if(l.length===0||s.length===0){alert("Please add hidden and output neurons");return}try{const x=y.map(J=>i.map(X=>parseFloat(J[X.label])||0)),v=y.map(J=>parseFloat(J.Truth)||0),M=i.map(J=>l.map(X=>{const lt=c[J.label]||J.label,dt=c[X.label]||X.label;return d[`${lt}-${dt}`]||0})),O=l.map(J=>{const X=c[J.label]||J.label;return f[X]||0}),D=l.map(J=>s.map(X=>{const lt=c[J.label]||J.label,dt=c[X.label]||X.label;return g[`${lt}-${dt}`]||0})),_=s.map(J=>{const X=c[J.label]||J.label;return p[X]||0});let U=Zp(x,M);U=Qp(U,O);const L=eT(U);let V=Zp(L,D);V=Qp(V,_);const P=nT(V).map(J=>J[0]),W=aT(v,P);h({predictions:P,truthValues:v,losses:W,showResults:!0})}catch(x){console.error("Error in forward pass:",x),console.error("Error stack:",x.stack),alert("Error in calculation. Please check your inputs and weights.")}},Kp=({title:a,neurons:i,data:l,setData:s,onHeaderChange:c,onCellHover:d,isOutput:f=!1,truthValues:g=[],predictions:p=[],losses:h=[]})=>{const y=()=>{f||s(O=>[...O,{}])},x=(O,D,_)=>{f||(s(U=>{const L=[...U];return L[O]||(L[O]={}),L[O][D]=_,L}),O===l.length-1&&_.trim()!==""&&y())},v=(O,D,_)=>{D===_||f||(s(U=>U.map(L=>{if(L[D]!==void 0){const V={...L};return V[_]=L[D],delete V[D],V}return L})),c(D,_))},M=O=>O<.1?"#22c55e":O<1?"#eab308":"#ef4444";return!f&&i.length===0?null:H.jsxs("div",{className:"input-table-container",children:[H.jsx("h3",{className:"table-title",children:a}),H.jsxs("table",{className:"neural-table input-table",children:[H.jsx("thead",{children:H.jsxs("tr",{children:[H.jsx("th",{children:H.jsx("input",{type:"text",className:"header-input",value:"Truth",readOnly:!0})}),!f&&i.map(O=>H.jsx("th",{children:H.jsx("input",{type:"text",className:"header-input",value:O.label,onChange:D=>v(O.id,O.label,D.target.value||O.label),onKeyDown:D=>{D.key==="Enter"&&D.target.blur()}})},O.id)),f&&H.jsxs(H.Fragment,{children:[H.jsx("th",{children:H.jsx("input",{type:"text",className:"header-input",value:"ŷ",readOnly:!0})}),H.jsx("th",{children:H.jsx("input",{type:"text",className:"header-input",value:"Loss",readOnly:!0})})]})]})}),H.jsx("tbody",{children:(f?g:l).map((O,D)=>H.jsxs("tr",{children:[H.jsx("td",{children:H.jsx("input",{type:"number",className:"cell-input",value:f?g[D]:O.Truth||"",onChange:f?void 0:_=>{const U=_.target.value;(U===""||U==="0"||U==="1")&&x(D,"Truth",U)},placeholder:"0",min:"0",max:"1",step:"1",readOnly:f})}),!f&&i.map(_=>H.jsx("td",{children:H.jsx("input",{type:"number",className:"cell-input",value:O[_.label]||"",onChange:U=>x(D,_.label,U.target.value),onMouseEnter:()=>d("neuron",_.label),onMouseLeave:()=>d(null),onFocus:()=>d("neuron",_.label),onBlur:()=>d(null),placeholder:"0",step:"0.1"})},_.id)),f&&H.jsxs(H.Fragment,{children:[H.jsx("td",{children:H.jsx("input",{type:"number",className:"cell-input",value:p[D]?.toFixed(4)||"",readOnly:!0})}),H.jsx("td",{children:H.jsx("input",{type:"number",className:"cell-input",value:h[D]?.toFixed(4)||"",style:{backgroundColor:h[D]?M(h[D]):"transparent",color:h[D]&&h[D]<1?"#000":"#fff"},readOnly:!0})})]})]},D))})]})]})},Jp=({title:a,inputLabels:i,neuronLabels:l,weights:s,biases:c,onWeightChange:d,onBiasChange:f,onHeaderChange:g,showSaveLoad:p,onSave:h,onLoad:y,onCellHover:x})=>l.length===0?null:H.jsxs("div",{className:"weights-table-container",children:[H.jsxs("div",{className:"table-header",children:[H.jsx("h3",{className:"table-title",children:a}),p]}),H.jsxs("table",{className:"neural-table weights-table",children:[H.jsxs("thead",{children:[H.jsxs("tr",{children:[H.jsx("th",{className:"bias-label",children:"b1"}),l.map((v,M)=>H.jsx("th",{children:H.jsx("input",{type:"number",className:"bias-input",value:c[v]||"",onChange:O=>f(v,O.target.value),onMouseEnter:()=>x("neuron",v),onMouseLeave:()=>x(null),onFocus:()=>x("neuron",v),onBlur:()=>x(null),placeholder:"0.5",step:"0.1"})},M))]}),H.jsxs("tr",{children:[H.jsx("th",{}),l.map((v,M)=>H.jsx("th",{children:H.jsx("input",{type:"text",className:"header-input",defaultValue:v,onBlur:O=>g(v,O.target.value||v),onKeyDown:O=>{O.key==="Enter"&&O.target.blur()}})},M))]})]}),H.jsx("tbody",{children:i.map((v,M)=>H.jsxs("tr",{children:[H.jsx("td",{className:"row-header",children:v}),l.map((O,D)=>H.jsx("td",{children:H.jsx("input",{type:"number",className:"cell-input",value:s[`${v}-${O}`]||"",onChange:_=>d(v,O,_.target.value),onMouseEnter:()=>x("connection",v,O),onMouseLeave:()=>x(null),onFocus:()=>x("connection",v,O),onBlur:()=>x(null),placeholder:"0.1",step:"0.1"})},D))]},M))})]})]}),oT=a=>{const{setNeuronHeaders:i,setHiddenWeights:l,setHiddenBiases:s,setOutputWeights:c,setOutputBiases:d}=a;return{handleInputHeaderChange:(f,g)=>{i(p=>({...p,[f]:g}))},handleWeightChange:(f,g,p)=>{l(h=>({...h,[`${f}-${g}`]:parseFloat(p)||0}))},handleBiasChange:(f,g)=>{s(p=>({...p,[f]:parseFloat(g)||0}))},handleOutputWeightChange:(f,g,p)=>{c(h=>({...h,[`${f}-${g}`]:parseFloat(p)||0}))},handleOutputBiasChange:(f,g)=>{d(p=>({...p,[f]:parseFloat(g)||0}))},handleNeuronHeaderChange:(f,g)=>{i(p=>({...p,[f]:g}))}}},Cy=(a,i)=>a==="input"?`X${i}`:a==="hidden"?`H${i}`:a.startsWith("hidden")?`H${parseInt(a.replace("hidden",""))}${i}`:`Y${i}`,lT=(a,i,l,s,c)=>{let d;a==="input"?d=200:a==="hidden"?d=400:a.startsWith("hidden")?d=400+((parseInt(a.replace("hidden",""))||1)-1)*100:d=400+l*100+100;const f=s-100-90*(i-1);return{x:d,y:f}},rT=(a,i,l,s,c)=>{const{x:d,y:f}=lT(a,i,l,s);return{id:`${a}-${Date.now()}`,x:d,y:f,radius:c,label:Cy(a,i),type:a}},sT=(a,i,l,s,c,d,f)=>{const g=i[a]+1,p=rT(a,g,c,d,f);l(h=>{const y=[...h,p],x=y.filter(v=>v.type===a).sort((v,M)=>v.y-M.y);return y.map(v=>{if(v.type===a){const M=x.findIndex(O=>O.id===v.id);return{...v,label:Cy(a,M+1)}}return v})}),s(h=>({...h,[a]:g}))},uT=async(a,i,l)=>{l(!0);const s=a.filter(h=>h.type==="input").sort((h,y)=>h.y-y.y),c=a.filter(h=>h.type==="hidden"||h.type.startsWith("hidden")).sort((h,y)=>h.x-y.x||h.y-y.y),d=a.filter(h=>h.type==="output").sort((h,y)=>h.y-y.y);if(s.length===0||c.length===0)return;const f={};c.forEach(h=>{const y=h.x;f[y]||(f[y]=[]),f[y].push(h)});const g=Object.keys(f).map(Number).sort(),p=[];if(g.length>0){const h=f[g[0]],y=[];for(const x of s)for(const v of h)y.push({id:`connection-${Date.now()}-${Math.random()}`,fromNeuronId:x.id,toNeuronId:v.id,fromDirection:"right",toDirection:"left",isAnimating:!0});p.push(y)}for(let h=0;h<g.length-1;h++){const y=f[g[h]],x=f[g[h+1]],v=[];for(const M of y)for(const O of x)v.push({id:`connection-${Date.now()}-${Math.random()}`,fromNeuronId:M.id,toNeuronId:O.id,fromDirection:"right",toDirection:"left",isAnimating:!0});p.push(v)}if(d.length>0&&g.length>0){const h=f[g[g.length-1]],y=[];for(const x of h)for(const v of d)y.push({id:`connection-${Date.now()}-${Math.random()}`,fromNeuronId:x.id,toNeuronId:v.id,fromDirection:"right",toDirection:"left",isAnimating:!0});p.push(y)}p.forEach((h,y)=>{setTimeout(()=>{i(x=>[...x,...h]),setTimeout(()=>{i(x=>x.map(v=>h.some(M=>M.id===v.id)?{...v,isAnimating:!1}:v))},600)},100+y*700)})},Fp=`
{
  "inputData": [
    {
      "X1": "60",
...
}`;function cT(){const[a,i]=G.useState([]),[l,s]=G.useState([]),[c,d]=G.useState(!1),[f,g]=G.useState(1),[p,h]=G.useState(null),[y,x]=G.useState(null),[v,M]=G.useState({input:0,hidden:0,output:0,...Array.from({length:10},(Y,F)=>({[`hidden${F+2}`]:0})).reduce((Y,F)=>({...Y,...F}),{})}),[O,D]=G.useState([{}]),[_,U]=G.useState({}),[L,V]=G.useState({}),[$,P]=G.useState({}),[W,J]=G.useState({}),[X,lt]=G.useState({}),[dt,Mt]=G.useState(null),[Ut,Kt]=G.useState({x:0,y:0}),[qt,Tt]=G.useState(null),[N,Z]=G.useState({}),[et,gt]=G.useState([]),[T,q]=G.useState([]),[Q,K]=G.useState([]),[tt,st]=G.useState(!1),[at,Bt]=G.useState(!1),[I,mt]=G.useState(!1),[At,Ct]=G.useState(!1),[Xt,Pt]=G.useState([]),[ce,rn]=G.useState(0),[Ge,ge]=G.useState(!1),[Aa,sn]=G.useState(null),[Rn,Ze]=G.useState(!1);G.useEffect(()=>{if(!localStorage.getItem("neuralNetworkData")){Ze(!0);const Y=setTimeout(()=>Ze(!1),6e3);return()=>clearTimeout(Y)}},[]);const Kn=G.useRef(null),we=30,Wr=400,Ir=async()=>{if(Ce.length===0)return;Bt(!0),st(!1),Ct(!0),rn(0),ge(!1),sn(null);const Y=async F=>{const Dt=Ce[F];if(!Dt)return;const Rt=l.filter(bt=>bt.toNeuronId===Dt.id&&cn.some(te=>te.id===bt.fromNeuronId)).map(bt=>bt.id);Pt(bt=>Array.from(new Set([...bt,...Rt]))),await new Promise(bt=>setTimeout(bt,3e3)),Pt(bt=>bt.filter(te=>!Rt.includes(te)));const Lt=l.filter(bt=>bt.fromNeuronId===Dt.id&&vn.some(te=>te.id===bt.toNeuronId)).map(bt=>bt.id);Pt(bt=>Array.from(new Set([...bt,...Lt]))),await new Promise(bt=>setTimeout(bt,2e3))};for(let F=0;F<Ce.length;F++)await Y(F);if(ge(!0),await new Promise(F=>setTimeout(F,3e3)),vn.length>0){const F=vn[0],Dt={id:`display-${Date.now()}`,x:F.x+150,y:F.y,radius:30,label:"0.9970",type:"display"};sn(Dt),i(Lt=>[...Lt,Dt]);const Rt={id:`sigmoid-connection-${Date.now()}`,fromNeuronId:F.id,toNeuronId:Dt.id,fromDirection:"right",toDirection:"left",isSigmoidConnection:!0};s(Lt=>[...Lt,Rt]),Pt(Lt=>[...Lt,Rt.id])}setTimeout(()=>{Bt(!1),Oa()},2e3)},Oa=()=>{iT(O,cn,Ce,vn,X,_,L,$,W,Y=>{gt(Y.predictions),q(Y.truthValues),K(Y.losses),st(Y.showResults)})},{handleInputHeaderChange:Oe,handleWeightChange:bn,handleBiasChange:De,handleOutputWeightChange:ts,handleOutputBiasChange:es,handleNeuronHeaderChange:dl}=oT({setNeuronHeaders:lt,setHiddenWeights:U,setHiddenBiases:V,setOutputWeights:P,setOutputBiases:J}),Da=()=>{const Y=a.filter(Rt=>Rt.type!=="display"),F=l.filter(Rt=>!Rt.isSigmoidConnection),Dt={inputData:O,hiddenWeights:_,hiddenBiases:L,outputWeights:$,outputBiases:W,neuronHeaders:X,neurons:Y,connections:F,counters:v,timestamp:new Date().toISOString()};localStorage.setItem("neuralNetworkData",JSON.stringify(Dt))},Ea=()=>{Ze(!1);let Y=localStorage.getItem("neuralNetworkData");Y||(Y=Fp,localStorage.setItem("neuralNetworkData",Fp));try{const F=JSON.parse(Y);D(F.inputData||[{}]),U(F.hiddenWeights||{}),V(F.hiddenBiases||{}),P(F.outputWeights||{}),J(F.outputBiases||{}),lt(F.neuronHeaders||{}),F.neurons&&i(F.neurons),F.connections&&(s(F.connections),mt(!0)),F.counters&&M(F.counters)}catch(F){console.error("Error loading network data:",F)}},un=(Y,F,Dt)=>{if(Y==="connection"&&F&&Dt){const Rt=a.find(bt=>(X[bt.label]||bt.label)===F),Lt=a.find(bt=>(X[bt.label]||bt.label)===Dt);if(Rt&&Lt){const bt=l.find(te=>te.fromNeuronId===Rt.id&&te.toNeuronId===Lt.id);h(bt?.id||null)}x(null)}else if(Y==="neuron"&&F){const Rt=a.find(Lt=>(X[Lt.label]||Lt.label)===F);x(Rt?.id||null),h(null)}else h(null),x(null)},cn=a.filter(Y=>Y.type==="input").sort((Y,F)=>Y.y-F.y),Ce=a.filter(Y=>Y.type==="hidden").sort((Y,F)=>Y.y-F.y),vn=a.filter(Y=>Y.type==="output").sort((Y,F)=>Y.y-F.y),hl=cn.map(Y=>X[Y.label]||Y.label),Qi=Ce.map(Y=>X[Y.label]||Y.label),Ki=vn.map(Y=>X[Y.label]||Y.label),Jn=Y=>{if(!Kn.current)return{x:0,y:0};const F=Kn.current.getBoundingClientRect(),Dt=(Y.clientX-F.left)/F.width*800,Rt=(Y.clientY-F.top)/F.height*400;return{x:Dt,y:Rt}},ns=(Y,F,Dt)=>{Z(Rt=>({...Rt,[Y]:{x:F,y:Dt}}))},ml=G.useCallback(Y=>{if(dt&&Kn.current){const F=Jn(Y);Kt(F);let Dt=null,Rt=1/0;a.forEach(Lt=>{if(Lt.id!==dt.fromNeuronId){const bt=N[Lt.id]||{x:0,y:0},te=Lt.x+bt.x,Ee=Lt.y+bt.y;[{direction:"top",x:te,y:Ee-we},{direction:"right",x:te+we,y:Ee},{direction:"bottom",x:te,y:Ee+we},{direction:"left",x:te-we,y:Ee}].forEach(je=>{const Qe=Math.sqrt(Math.pow(F.x-je.x,2)+Math.pow(F.y-je.y,2));Qe<15&&Qe<Rt&&(Rt=Qe,Dt={neuronId:Lt.id,direction:je.direction})})}}),Tt(Dt)}},[dt,a,N,we]),pl=Y=>{sT(Y,v,i,M,f,Wr,we)},Ji=(Y,F,Dt)=>{i(Rt=>Rt.map(Lt=>Lt.id===Y?{...Lt,x:F,y:Dt}:Lt))},Fi=(Y,F,Dt,Rt,Lt)=>{if(dt)if(Y!==dt.fromNeuronId){const bt={id:`connection-${Date.now()}`,fromNeuronId:dt.fromNeuronId,toNeuronId:Y,fromDirection:dt.fromDirection,toDirection:F};s(te=>[...te,bt]),Mt(null),Tt(null)}else Mt(null),Tt(null);else{const bt=a.find(Ma=>Ma.id===Y),te=N[Y]||{x:0,y:0},Ee=bt.x+te.x,wn=bt.y+te.y,je={top:{x:Ee,y:wn-we},right:{x:Ee+we,y:wn},bottom:{x:Ee,y:wn+we},left:{x:Ee-we,y:wn}},Qe=Jn(Lt);Mt({fromNeuronId:Y,fromDirection:F,startX:je[F].x,startY:je[F].y}),Kt(Qe)}},gl=()=>{uT(a,s,mt)},as=Y=>{Y.target.classList.contains("network-svg")&&dt&&(Mt(null),Tt(null))},fn=(Y,F,Dt=()=>pl(Y),Rt=0)=>H.jsx(pe.button,{onClick:Dt,className:"spawn-btn",whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},initial:{opacity:0,y:20-Rt},animate:{opacity:1,y:-25},transition:{delay:.1,duration:.1},children:F},Y);return H.jsxs("div",{className:"app-container",children:[H.jsxs("div",{style:{position:"fixed",top:0,left:10,zIndex:100,background:"transparent",padding:"18px 24px 0 24px",color:"white",fontSize:"1rem",letterSpacing:"0.04em"},children:[H.jsx("a",{href:"../matrix_tool/",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"Home"}),H.jsx("a",{href:"https://www.linkedin.com/in/laish-glenberg/",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"About"})]}),H.jsxs(pe.div,{className:"content-wrapper-with-tables",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{duration:1,ease:"easeOut"},children:[H.jsxs("div",{className:"left-panel",children:[H.jsx(Kp,{title:"Input Col Vectors",neurons:cn,data:O,setData:D,onHeaderChange:Oe,onCellHover:un,isOutput:!1}),at&&H.jsx("div",{style:{minHeight:"300px",display:"flex",alignItems:"center",justifyContent:"center",width:"100%"},children:H.jsx(FS,{color:["#7e7e7e","#979797","#b1b1b1","#cacaca"]})}),tt&&!at&&H.jsx(pe.div,{initial:{opacity:0,y:30,scale:.95},animate:{opacity:1,y:0,scale:1},transition:{duration:.7,ease:"easeOut"},children:H.jsx(Kp,{title:"Final Predictions",neurons:[],data:[],setData:()=>{},onHeaderChange:()=>{},onCellHover:()=>{},isOutput:!0,truthValues:T,predictions:et,losses:Q})})]}),H.jsxs("div",{className:"center-panel",children:[H.jsxs("div",{className:"main-title-row",style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",marginBottom:"5px",position:"relative"},children:[H.jsx(pe.h1,{className:"main-title",initial:{opacity:0,y:-30},animate:{opacity:1,y:10},transition:{delay:.3,duration:.8},style:{margin:0},children:"Neural Network Builder"}),H.jsxs("div",{className:"save-load-buttons",style:{position:"absolute",right:0,top:"50%",transform:"translateY(-50%)"},children:[H.jsx("button",{className:"save-load-btn",title:"Save all table values in cookies",onClick:Da,style:{marginRight:"8px"},children:"Save"}),H.jsx("button",{className:`save-load-btn${Rn?" flash":""}`,title:"Load tables from cookies",onClick:Ea,children:"Load"})]})]}),a.some(Y=>Y.type==="output")&&a.some(Y=>Y.type==="input")&&a.some(Y=>Y.type==="hidden")&&H.jsxs(pe.button,{onClick:Ir,className:`spawn-btn${I?"":" btn-disabled"}`,style:{marginTop:"10px",marginBottom:"0px",fontSize:"16px",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"center",whiteSpace:"nowrap"},disabled:!I,whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.1,duration:.1},children:["START",H.jsx("img",{src:CS,alt:"Train",style:{marginLeft:"10px",width:22,height:22,filter:"invert(1)",transform:"scaleX(-1)"}})]}),H.jsxs(pe.svg,{ref:Kn,width:"100%",height:"400",viewBox:"0 0 800 400",className:"network-svg",initial:{opacity:0},animate:{opacity:1},transition:{delay:.6,duration:1},onMouseMove:ml,onClick:as,children:[H.jsx("defs",{children:H.jsx("marker",{id:"arrowhead",markerWidth:"10",markerHeight:"7",refX:"9",refY:"3.5",orient:"auto",children:H.jsx("polygon",{points:"0 0, 10 3.5, 0 7",className:"arrow-marker"})})}),l.map(Y=>H.jsx(WS,{connection:Y,neurons:a,neuronRadius:we,neuronTransforms:N,isGlowing:p===Y.id,emphasizedConnections:Xt,showForwardPassVisuals:At,inputData:O,currentSampleIndex:ce,neuronHeaders:X,hiddenWeights:_,inputNeurons:cn,hiddenNeurons:Ce,hiddenBiases:L,outputWeights:$,outputBiases:W,showSigmoidPhase:Ge,outputNeurons:vn},Y.id)),dt&&H.jsx($S,{startX:dt.startX,startY:dt.startY,endX:Ut.x,endY:Ut.y}),a.map(Y=>H.jsx(tT,{id:Y.id,x:Y.x,y:Y.y,radius:Y.radius,label:Y.label,type:Y.type,onDragEnd:Ji,onDragUpdate:ns,onStartConnection:Fi,highlightedDots:qt?.neuronId===Y.id?[qt.direction]:[],isGlowing:y===Y.id,neurons:a,showForwardPassVisuals:At,emphasizedConnections:Xt,hiddenNeurons:Ce,inputNeurons:cn,outputNeurons:vn,neuronHeaders:X,hiddenWeights:_,outputWeights:$,inputData:O,currentSampleIndex:ce,hiddenBiases:L,connections:l,showSigmoidPhase:Ge,outputBiases:W},Y.id))]}),H.jsxs("div",{className:"button-stack",children:[H.jsx("div",{className:"button-dense",children:a.some(Y=>Y.type==="input")&&a.some(Y=>Y.type==="hidden")&&fn("dense","Dense Connect",gl)}),H.jsx("div",{className:"button-container",children:[{type:"input",label:"Add Input"},{type:"hidden",label:"Add Hidden"},...c?Array.from({length:f-1},(Y,F)=>({type:`hidden${F+2}`,label:`Add Hidden ${F+2}`})):[],{type:"output",label:"Add Output"}].map(({type:Y,label:F})=>fn(Y,F))})]})]}),H.jsxs("div",{className:"right-panel",children:[H.jsx(Jp,{title:"Hidden Layer Weights",inputLabels:hl,neuronLabels:Qi,weights:_,biases:L,onWeightChange:bn,onBiasChange:De,onHeaderChange:dl,showSaveLoad:!0,onSave:Da,onLoad:Ea,onCellHover:un}),Ce.length>0&&vn.length>0&&H.jsx(Jp,{title:"Output Layer Weights",inputLabels:Qi,neuronLabels:Ki,weights:$,biases:W,onWeightChange:ts,onBiasChange:es,onHeaderChange:dl,showSaveLoad:!1,onCellHover:un})]})]})]})}Jv.createRoot(document.getElementById("root")).render(H.jsx(G.StrictMode,{children:H.jsx(cT,{})}));
