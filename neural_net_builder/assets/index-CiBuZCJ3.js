...
}`);at(Nl).toRgb();Array.from({length:4},function(a,i){return"--atom-phase".concat(i+1,"-rgb")});Oe(`.commet-rli-bounding-box {
...
}`);Array.from({length:4},function(a,i){return"--OP-annulus-phase".concat(i+1,"-color")});function Qc(a){return a&&a.Math===Math&&a}Oe(`.OP-dotted-rli-bounding-box {
...
}`);Qc(typeof window=="object"&&window)||Qc(typeof self=="object"&&self)||Qc(typeof global=="object"&&global)||function(){return this}()||Function("return this")();Array.from({length:4},function(a,i){return"--OP-dotted-phase".concat(i+1,"-color")});Oe(`.OP-spokes-rli-bounding-box {
...
}`);Array.from({length:4},function(a,i){return"--life-line-phase".concat(i+1,"-color")});const eg="data:image/svg+xml,%3c?xml%20version='1.0'?%3e%3csvg%20width='124'%20height='346'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:svg='http://www.w3.org/2000/svg'%3e%3c!--%20Created%20with%20SVG-edit%20-%20https://github.com/SVG-Edit/svgedit--%3e%3cg%20class='layer'%3e%3ctitle%3eLayer%201%3c/title%3e%3cpath%20d='m5,79.76l57,-74.77l57,74.77l-28.5,0l0,75.13l-57,0l0,-75.13z'%20fill='%23000000'%20fill-opacity='0'%20id='svg_4'%20stroke='%23000000'%20stroke-linecap='round'%20stroke-linejoin='round'%20stroke-width='13'%20transform='rotate(180%2062.0005%2079.9424)'/%3e%3cpath%20d='m5,265.76l57,-74.77l57,74.77l-28.5,0l0,75.13l-57,0l0,-75.13z'%20fill='%23000000'%20fill-opacity='0'%20id='svg_6'%20stroke='%23000000'%20stroke-linecap='round'%20stroke-linejoin='round'%20stroke-width='13'/%3e%3c/g%3e%3c/svg%3e",iT=({startX:a,startY:i,endX:l,endY:s})=>A.jsx(Ft.line,{x1:a,y1:i,x2:l,y2:s,className:"active-connection",markerEnd:"url(#arrowhead)",initial:{opacity:0},animate:{opacity:1},transition:{duration:.2}}),Xy=({x:a,y:i,sumText:l})=>A.jsxs("g",{children:[A.jsx("line",{x1:a-25,y1:i-5,x2:a+25,y2:i-5,stroke:"#ffffff",strokeWidth:"1"}),A.jsx("text",{x:a,y:i-10,fill:"#ffffff",fontSize:"12px",textAnchor:"middle",children:"1"}),A.jsx("text",{x:a-10,y:i+10,fill:"#ffffff",fontSize:"12px",textAnchor:"middle",children:"1 + e"}),A.jsxs("text",{x:a+8,y:i+5,fill:"#ffffff",fontSize:"8px",textAnchor:"start",children:["-",l]})]}),oT=({connection:a,neurons:i,neuronRadius:l,neuronTransforms:s,isGlowing:c,emphasizedConnections:d,showForwardPassVisuals:f,inputData:g,currentSampleIndex:p,neuronHeaders:h,hiddenWeights:y,inputNeurons:v,hiddenNeurons:x,hiddenBiases:w,outputWeights:M,outputBiases:D,showSigmoidPhase:_,outputNeurons:B,isEraserMode:X,onEraseConnection:q,eraserHoveredConnection:W,setEraserHoveredConnection:P})=>{const F=i.find(Nt=>Nt.id===a.fromNeuronId),Q=i.find(Nt=>Nt.id===a.toNeuronId);if(!F||!Q)return null;const G=W===a.id,lt=d.includes(a.id),ct=f?lt?1:.3:1,jt=s[a.fromNeuronId]||{x:0,y:0},Gt=s[a.toNeuronId]||{x:0,y:0},Ne=F.x+jt.x,pe=F.y+jt.y,Zt=Q.x+Gt.x,k=Q.y+Gt.y,Z=(Nt,It,Qt,Ct)=>{switch(It){case"top":return{x:Qt,y:Ct-l};case"right":return{x:Qt+l,y:Ct};case"bottom":return{x:Qt,y:Ct+l};case"left":return{x:Qt-l,y:Ct};default:return{x:Qt,y:Ct}}},$=Z(F,a.fromDirection,Ne,pe),pt=Z(Q,a.toDirection,Zt,k),T=($.x+pt.x)/2;let H=($.y+pt.y)/2;const I=Math.atan2(pt.y-$.y,pt.x-$.x)*(180/Math.PI),J=()=>{if(!f||!g[p]||!d.includes(a.id))return null;const Nt=h[F.label]||F.label,It=h[Q.label]||Q.label;if(F.type==="input"&&Q.type==="hidden"){const Qt=parseFloat(g[p][Nt])||0,Ct=y[`${Nt}-${It}`]||0,et=w[It]||0,St=Qt*Ct+et;return`${Qt} × ${Ct.toFixed(1)} + ${et.toFixed(1)} = ${St.toFixed(1)}`}if(F.type==="hidden"&&Q.type==="output"){let Qt=0;v.forEach(ge=>{const ie=h[ge.label]||ge.label,Ze=parseFloat(g[p][ie])||0,xe=y[`${ie}-${Nt}`]||0;Qt+=Ze*xe});const Ct=w[Nt]||0,et=Qt+Ct,St=Math.max(0,et),wt=M[`${Nt}-${It}`]||0;D[It];const Dt=(St*wt).toFixed(1);return`${St.toFixed(0)} × ${wt.toFixed(1)} = ${Dt}`}return F.type==="output"&&Q.type==="display"&&a.isSigmoidConnection,null},it=()=>{if(!(F.type==="output"&&Q.type==="display"&&a.isSigmoidConnection))return null;H-=20;const Nt=h[F.label]||F.label;let It=0;x.forEach(et=>{const St=h[et.label]||et.label;let wt=0;v.forEach(xe=>{const on=h[xe.label]||xe.label,Nn=parseFloat(g[p][on])||0,kn=y[`${on}-${St}`]||0;wt+=Nn*kn});const Dt=w[St]||0,ge=wt+Dt,ie=Math.max(0,ge),Ze=M[`${St}-${Nt}`]||0;It+=ie*Ze});const Qt=D[Nt]||0;It+=Qt;const Ct=It.toFixed(1);return A.jsx(Xy,{x:T,y:H,sumText:Ct})},gt=(Nt,It,Qt)=>{let Ct=-1;for(let wt=0;wt<Nt&&(Ct=Qt.indexOf(" ",Ct+1),Ct!==-1);wt++);const et=Qt.slice(0,Ct),St=Qt.slice(Ct);return A.jsxs(A.Fragment,{children:[et,A.jsx("tspan",{fontSize:"8px",dy:"2",dx:"1",children:It}),St]})};function ot(Nt,It="11px Segoe UI"){const Ct=document.createElement("canvas").getContext("2d");return Ct.font=It,Ct.measureText(Nt).width+16}let Ut=J(),Et="11px";if(Ut){const Nt=Math.sqrt(Math.pow(pt.x-$.x,2)+Math.pow(pt.y-$.y,2));ot(Ut)>Nt&&(Et="9px",console.log("too big")),Ut=gt(3,Q.label.toLowerCase(),Ut)}const Be=a.isAnimating?"active-connection":c?"completed-connection glowing-connection":"completed-connection";return A.jsxs("g",{children:[A.jsx(Ft.line,{x1:$.x,y1:$.y,x2:pt.x,y2:pt.y,className:Be,markerEnd:a.isAnimating?void 0:"url(#arrowhead)",initial:a.isAnimating?{pathLength:0}:{pathLength:1,opacity:ct},animate:a.isAnimating?{pathLength:1,opacity:ct}:{opacity:ct,stroke:X&&G?"#ef4444":"#ffffff"},transition:a.isAnimating?{duration:.6,ease:"easeInOut"}:{duration:.2},style:{cursor:X?"crosshair":"default"},onMouseEnter:()=>{X&&P(a.id)},onMouseLeave:()=>{X&&P(null)},onClick:Nt=>{X&&(Nt.stopPropagation(),q(a.id))}}),Ut&&A.jsx(Ft.text,{x:T,y:H-8,className:"formula-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.5,duration:.5},style:{fontSize:Et,fill:"#ffffff",textAnchor:"middle",pointerEvents:"none"},transform:`rotate(${I}, ${T}, ${H-8})`,children:Ut}),d.includes(a.id)&&A.jsx(Ft.g,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.5,duration:.5},children:it()})]})},lT=({x:a,y:i,neuronId:l,direction:s,onStartConnection:c,isHighlighted:d=!1})=>A.jsx(Ft.circle,{cx:a,cy:i,r:4,className:`connection-dot ${d?"connection-dot-highlighted":""}`,onClick:f=>{f.stopPropagation(),c(l,s,a,i,f)},whileHover:{scale:1.2},initial:{scale:0},animate:{scale:1},exit:{scale:0},transition:{duration:.2},style:{cursor:"pointer"}}),rT=({id:a,x:i,y:l,radius:s,label:c,type:d,onDragEnd:f,onStartConnection:g,highlightedDots:p=[],onDragUpdate:h,isGlowing:y,neurons:v,showForwardPassVisuals:x,emphasizedConnections:w,hiddenNeurons:M,inputNeurons:D,outputNeurons:_,neuronHeaders:B,hiddenWeights:X,outputWeights:q,inputData:W,currentSampleIndex:P,hiddenBiases:F,connections:Q,showSigmoidPhase:G,outputBiases:lt,isEraserMode:ct,onEraseNeuron:jt,eraserHoveredNeuron:Gt,setEraserHoveredNeuron:Ne})=>{const[pe,Zt]=Y.useState(!1),[k,Z]=Y.useState(!1),$=Gt===a,pt=ct&&$?.5:1,T=v.find(et=>et.id===a),H=x&&(T?.type==="input"||T?.type==="hidden"&&Q.some(et=>w.includes(et.id)&&(et.fromNeuronId===a||et.toNeuronId===a))||T?.type==="output"&&(w.some(et=>{const St=Q.find(wt=>wt.id===et);return St&&St.toNeuronId===a})||G)||T?.type==="display"),I=x&&!H?.3:1,J=et=>{const St="neuron",wt=et==="input"?"neuron-input":et==="hidden"?"neuron-hidden":et==="output"?"neuron-output":et.startsWith("hidden")?"neuron-hidden":"neuron";return y?`${St} ${wt} glowing-neuron`:`${St} ${wt}`},gt=(et=>{const St=B[et.label]||et.label,wt=[];return et.type==="hidden"?D.forEach(Dt=>{const ge=B[Dt.label]||Dt.label,ie=X[`${ge}-${St}`]||0;wt.push(ie)}):et.type==="output"&&M.forEach(Dt=>{const ge=B[Dt.label]||Dt.label,ie=q[`${ge}-${St}`]||0;wt.push(ie)}),wt})(T||{type:d,label:c}),ot=gt.length>0?`[${gt.map(et=>et.toFixed(1)).join(", ")}]`:"",Ut=()=>{if(d==="input"&&x&&W[P]){const et=B[c]||c;return W[P][et]||""}return""},Et=()=>{if(d==="hidden"&&x&&W[P]){const et=B[c]||c;if(Q.some(wt=>w.includes(wt.id)&&wt.toNeuronId===a&&D.some(Dt=>Dt.id===wt.fromNeuronId))){let wt=0;D.forEach(ie=>{const Ze=B[ie.label]||ie.label,xe=parseFloat(W[P][Ze])||0,on=X[`${Ze}-${et}`]||0;wt+=xe*on});const Dt=F[et]||0;return(wt+Dt).toFixed(1)}}return""},Be=()=>{if(d==="output"&&x&&G&&W[P]){const et=B[c]||c,St=[];M.forEach(Dt=>{const ge=B[Dt.label]||Dt.label;let ie=0;D.forEach(Xn=>{const ke=B[Xn.label]||Xn.label,Se=parseFloat(W[P][ke])||0,mn=X[`${ke}-${ge}`]||0;ie+=Se*mn});const Ze=F[ge]||0,xe=ie+Ze,on=Math.max(0,xe),Nn=q[`${ge}-${et}`]||0,kn=on*Nn;St.push(kn.toFixed(1))});const wt=lt[et]||0;return`${St.join(" + ")} + ${wt.toFixed(1)}`}return""},Nt=()=>{if(d==="output"&&x&&G&&W[P]){const et=B[c]||c;let St=0;M.forEach(Dt=>{const ge=B[Dt.label]||Dt.label;let ie=0;D.forEach(kn=>{const Xn=B[kn.label]||kn.label,ke=parseFloat(W[P][Xn])||0,Se=X[`${Xn}-${ge}`]||0;ie+=ke*Se});const Ze=F[ge]||0,xe=ie+Ze,on=Math.max(0,xe),Nn=q[`${ge}-${et}`]||0;St+=on*Nn});const wt=lt[et]||0;return St+=wt,St.toFixed(1)}return""},It=[{direction:"top",x:0,y:-s},{direction:"right",x:s,y:0},{direction:"bottom",x:0,y:s},{direction:"left",x:-s,y:0}],Qt=()=>{pe||(Z(!0),ct&&Ne(a))},Ct=()=>{Z(!1),ct&&Ne(null)};return A.jsxs(Ft.g,{drag:!0,dragMomentum:!1,dragElastic:.1,initial:{x:i,y:l},animate:{x:i,y:l,opacity:I},onDragStart:()=>{Zt(!0),Z(!1)},onDrag:(et,St)=>{h(a,St.offset.x,St.offset.y)},onDragEnd:(et,St)=>{Zt(!1);const wt=i+St.offset.x,Dt=l+St.offset.y;f(a,wt,Dt),h(a,0,0)},whileDrag:{scale:1.1},onMouseEnter:Qt,onMouseLeave:Ct,style:{cursor:pe?"grabbing":"default"},children:[A.jsx("circle",{cx:0,cy:0,r:s+20,fill:"transparent",style:{pointerEvents:"all",cursor:"default"}}),A.jsx(Ft.circle,{cx:0,cy:0,r:s,className:J(d),initial:{scale:0,opacity:0},animate:{scale:1,opacity:pt,stroke:ct&&$?"#ef4444":void 0,strokeWidth:ct&&$?3:void 0},transition:{duration:.6,type:"spring"},style:{cursor:ct?"crosshair":pe?"grabbing":"grab"},onClick:et=>{et.button===0&&ct&&(et.stopPropagation(),jt(a))}}),(Et()||d==="output"&&G)&&A.jsx("rect",{x:-23,y:-9,width:46,height:18,rx:3,fill:"rgb(6, 129, 0)",stroke:"#22c55e",strokeWidth:2}),A.jsx(Ft.text,{x:0,y:5,className:"neuron-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.3,duration:.5},style:{pointerEvents:"none"},children:Et()?"ReLU":d==="output"&&G?"Sig":c}),ot&&!(d==="output"&&G)&&A.jsx(Ft.text,{x:0,y:-s-10,className:Et()?"neuron-text":"neuron-weights-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.5,duration:.5},style:{},children:Et()||ot}),d==="output"&&G&&Be()&&A.jsxs(Ft.text,{x:0,y:-s-25,className:"formula-text",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.5},style:{fontSize:"11px",fill:"#ffffff",textAnchor:"middle",pointerEvents:"none"},children:[Be(),A.jsx("tspan",{fontSize:"8px",dy:"2",dx:"1",children:"b2"})]}),d==="output"&&G&&Nt()&&A.jsx(Ft.text,{x:0,y:-s-10,className:"neuron-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:1,duration:.5},style:{pointerEvents:"none"},children:Nt()}),d==="input"&&x&&Ut()&&A.jsx(Ft.text,{x:0,y:-s*1.3,className:"input-value-text",initial:{opacity:0},animate:{opacity:1},transition:{delay:.3,duration:.5},style:{pointerEvents:"none",fontSize:"14px",fill:"#ffffff",textAnchor:"middle"},children:Ut()}),A.jsx(ey,{children:k&&!pe&&It.map(et=>A.jsx(lT,{x:et.x,y:et.y,neuronId:a,direction:et.direction,onStartConnection:g,isHighlighted:p.includes(et.direction)},et.direction))})]})},ng=(a,i)=>{const l=a.length,s=a[0].length,c=i[0].length,d=Array(l).fill().map(()=>Array(c).fill(0));for(let f=0;f<l;f++)for(let g=0;g<c;g++)for(let p=0;p<s;p++)d[f][g]+=a[f][p]*i[p][g];return d},ag=(a,i)=>a.map(l=>l.map((s,c)=>s+(i[c]||0))),sT=a=>a.map(i=>i.map(l=>Math.max(0,l))),uT=a=>a.map(i=>i.map(l=>1/(1+Math.exp(-l)))),cT=(a,i)=>a.map((s,c)=>{const d=Math.max(1e-15,Math.min(.999999999999999,i[c]));return-(s*Math.log(d)+(1-s)*Math.log(1-d))}),fT=(a,i,l,s,c,d,f,g,p,h)=>{const y=a.filter(v=>{const x=i.some(M=>v[M.label]&&v[M.label].trim()!==""),w=v.Truth!==void 0&&v.Truth!=="";return x&&w});if(y.length===0){alert("Please add input data with truth values");return}if(l.length===0||s.length===0){alert("Please add hidden and output neurons");return}try{const v=y.map(Q=>i.map(G=>parseFloat(Q[G.label])||0)),x=y.map(Q=>parseFloat(Q.Truth)||0),w=i.map(Q=>l.map(G=>{const lt=c[Q.label]||Q.label,ct=c[G.label]||G.label;return d[`${lt}-${ct}`]||0})),M=l.map(Q=>{const G=c[Q.label]||Q.label;return f[G]||0}),D=l.map(Q=>s.map(G=>{const lt=c[Q.label]||Q.label,ct=c[G.label]||G.label;return g[`${lt}-${ct}`]||0})),_=s.map(Q=>{const G=c[Q.label]||Q.label;return p[G]||0});let B=ng(v,w);B=ag(B,M);const X=sT(B);let q=ng(X,D);q=ag(q,_);const P=uT(q).map(Q=>Q[0]),F=cT(x,P);h({predictions:P,truthValues:x,losses:F,showResults:!0})}catch(v){console.error("Error in forward pass:",v),console.error("Error stack:",v.stack),alert("Error in calculation. Please check your inputs and weights.")}},ig=({title:a,neurons:i,data:l,setData:s,onHeaderChange:c,onCellHover:d,isOutput:f=!1,truthValues:g=[],predictions:p=[],losses:h=[]})=>{const y=()=>{f||s(M=>[...M,{}])},v=(M,D,_)=>{f||(s(B=>{const X=[...B];return X[M]||(X[M]={}),X[M][D]=_,X}),M===l.length-1&&_.trim()!==""&&y())},x=(M,D,_)=>{D===_||f||(s(B=>B.map(X=>{if(X[D]!==void 0){const q={...X};return q[_]=X[D],delete q[D],q}return X})),c(D,_))},w=M=>M<.3?"#22c55e":M<.7?"#eab308":"#ef4444";return!f&&i.length===0?null:A.jsxs("div",{className:"input-table-container",children:[A.jsx("h3",{className:"table-title",children:a}),A.jsxs("table",{className:"neural-table input-table",children:[A.jsx("thead",{children:A.jsxs("tr",{children:[A.jsx("th",{children:A.jsx("input",{type:"text",className:"header-input",value:"Truth",readOnly:!0})}),!f&&i.map(M=>A.jsx("th",{children:A.jsx("input",{type:"text",className:"header-input",value:M.label,onChange:D=>x(M.id,M.label,D.target.value||M.label),onKeyDown:D=>{D.key==="Enter"&&D.target.blur()}})},M.id)),f&&A.jsxs(A.Fragment,{children:[A.jsx("th",{children:A.jsx("input",{type:"text",className:"header-input",value:"ŷ",readOnly:!0})}),A.jsx("th",{children:A.jsx("input",{type:"text",className:"header-input",value:"Loss",readOnly:!0})})]})]})}),A.jsx("tbody",{children:(f?g:l).map((M,D)=>A.jsxs("tr",{children:[A.jsx("td",{children:A.jsx("input",{type:"number",className:"cell-input",value:f?g[D]:M.Truth||"",onChange:f?void 0:_=>{const B=_.target.value;(B===""||B==="0"||B==="1")&&v(D,"Truth",B)},placeholder:"0",min:"0",max:"1",step:"1",readOnly:f})}),!f&&i.map(_=>A.jsx("td",{children:A.jsx("input",{type:"number",className:"cell-input",value:M[_.label]||"",onChange:B=>v(D,_.label,B.target.value),onMouseEnter:()=>d("neuron",_.label),onMouseLeave:()=>d(null),onFocus:()=>d("neuron",_.label),onBlur:()=>d(null),placeholder:"0",step:"0.1"})},_.id)),f&&A.jsxs(A.Fragment,{children:[A.jsx("td",{children:A.jsx("input",{type:"number",className:"cell-input",value:p[D]?.toFixed(4)||"",readOnly:!0})}),A.jsx("td",{children:A.jsx("input",{type:"number",className:"cell-input",value:h[D]?.toFixed(4)||"",style:{backgroundColor:h[D]?w(h[D]):"transparent",color:h[D]&&h[D]<1?"#000":"#fff"},readOnly:!0})})]})]},D))})]})]})},og=({title:a,inputLabels:i,neuronLabels:l,weights:s,biases:c,onWeightChange:d,onBiasChange:f,onHeaderChange:g,showSaveLoad:p,onSave:h,onLoad:y,onCellHover:v,biasLabel:x="b"})=>l.length===0?null:A.jsxs("div",{className:"weights-table-container",children:[A.jsxs("div",{className:"table-header",children:[A.jsx("h3",{className:"table-title",children:a}),p]}),A.jsxs("table",{className:"neural-table weights-table",children:[A.jsxs("thead",{children:[A.jsxs("tr",{children:[A.jsx("th",{className:"bias-label",children:x}),l.map((w,M)=>A.jsx("th",{children:A.jsx("input",{type:"number",className:"bias-input",value:c[w]||"",onChange:D=>f(w,D.target.value),onMouseEnter:()=>v("neuron",w),onMouseLeave:()=>v(null),onFocus:()=>v("neuron",w),onBlur:()=>v(null),placeholder:"0.5",step:"0.1"})},M))]}),A.jsxs("tr",{children:[A.jsx("th",{}),l.map((w,M)=>A.jsx("th",{children:A.jsx("input",{type:"text",className:"header-input",defaultValue:w,onBlur:D=>g(w,D.target.value||w),onKeyDown:D=>{D.key==="Enter"&&D.target.blur()}})},M))]})]}),A.jsx("tbody",{children:i.map((w,M)=>A.jsxs("tr",{children:[A.jsx("td",{className:"row-header",children:w}),l.map((D,_)=>A.jsx("td",{children:A.jsx("input",{type:"number",className:"cell-input",value:s[`${w}-${D}`]||"",onChange:B=>d(w,D,B.target.value),onMouseEnter:()=>v("connection",w,D),onMouseLeave:()=>v(null),onFocus:()=>v("connection",w,D),onBlur:()=>v(null),placeholder:"0.1",step:"0.1"})},_))]},M))})]})]}),Yy=(a,i)=>a==="input"?`X${i}`:a==="hidden"?`H${i}`:a.startsWith("hidden")?`H${parseInt(a.replace("hidden",""))}${i}`:`Y${i}`,dT=(a,i,l,s,c)=>{let d;a==="input"?d=200:a==="hidden"?d=400:a.startsWith("hidden")?d=400+((parseInt(a.replace("hidden",""))||1)-1)*100:d=400+l*100+100;const f=s-100-90*(i-1);return{x:d,y:f}},hT=(a,i,l,s,c)=>{const{x:d,y:f}=dT(a,i,l,s);return{id:`${a}-${Date.now()}`,x:d,y:f,radius:c,label:Yy(a,i),type:a}},mT=(a,i,l,s,c,d,f)=>{const g=i[a]+1,p=hT(a,g,c,d,f);l(h=>{const y=[...h,p],v=y.filter(x=>x.type===a).sort((x,w)=>x.y-w.y);return y.map(x=>{if(x.type===a){const w=v.findIndex(M=>M.id===x.id);return{...x,label:Yy(a,w+1)}}return x})}),s(h=>({...h,[a]:g}))},pT=async(a,i,l)=>{l(!0);const s=a.filter(h=>h.type==="input").sort((h,y)=>h.y-y.y),c=a.filter(h=>h.type==="hidden"||h.type.startsWith("hidden")).sort((h,y)=>h.x-y.x||h.y-y.y),d=a.filter(h=>h.type==="output").sort((h,y)=>h.y-y.y);if(s.length===0||c.length===0)return;const f={};c.forEach(h=>{const y=h.x;f[y]||(f[y]=[]),f[y].push(h)});const g=Object.keys(f).map(Number).sort(),p=[];if(g.length>0){const h=f[g[0]],y=[];for(const v of s)for(const x of h)y.push({id:`connection-${Date.now()}-${Math.random()}`,fromNeuronId:v.id,toNeuronId:x.id,fromDirection:"right",toDirection:"left",isAnimating:!0});p.push(y)}for(let h=0;h<g.length-1;h++){const y=f[g[h]],v=f[g[h+1]],x=[];for(const w of y)for(const M of v)x.push({id:`connection-${Date.now()}-${Math.random()}`,fromNeuronId:w.id,toNeuronId:M.id,fromDirection:"right",toDirection:"left",isAnimating:!0});p.push(x)}if(d.length>0&&g.length>0){const h=f[g[g.length-1]],y=[];for(const v of h)for(const x of d)y.push({id:`connection-${Date.now()}-${Math.random()}`,fromNeuronId:v.id,toNeuronId:x.id,fromDirection:"right",toDirection:"left",isAnimating:!0});p.push(y)}p.forEach((h,y)=>{setTimeout(()=>{i(v=>[...v,...h]),setTimeout(()=>{i(v=>v.map(x=>h.some(w=>w.id===x.id)?{...x,isAnimating:!1}:x))},600)},100+y*700)})},lg=`
{
  "inputData": [
    {
      "X1": "60",
...
}`,gT="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='22'%20height='18'%20viewBox='0%200%2022%2018'%3e%3cg%3e%3cpolygon%20points='15.828%206%2018%206%2018%208%2022%204%2018%200%2018%202%2014.172%202%204.172%2012%200%2012%200%2016%205.828%2016%2015.828%206'/%3e%3cpolygon%20points='18%2010%2018%2012%2015.828%2012%2014.242%2010.414%2011.414%2013.242%2014.172%2016%2018%2016%2018%2018%2022%2014%2018%2010'/%3e%3cpolygon%20points='5.758%207.586%208.586%204.758%205.828%202%200%202%200%206%204.172%206%205.758%207.586'/%3e%3c/g%3e%3c/svg%3e",nn=({matrix:a,label:i,image:l,x:s=0,y:c=0})=>{if(!a||a.length===0)return null;const d=a.length,f=a[0]?.length||0,g=40,p=4;return A.jsxs("div",{className:"matrix-display",style:{position:"relative",fontFamily:"monospace",color:"white"},children:[i&&A.jsx("div",{className:"matrix-label",style:{position:"absolute",top:"-2.2rem",left:"50%",transform:"translateX(-50%)",fontSize:"18px",fontWeight:"bold",whiteSpace:"nowrap"},children:A.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},children:[A.jsx("span",{children:i}),l]})}),A.jsxs("div",{className:"matrix-container",style:{position:"relative"},children:[A.jsx("div",{className:"matrix-bracket-left",style:{position:"absolute",left:"-8px",top:"0",height:`${d*(g+p)-p}px`,width:"6px",borderLeft:"2px solid white",borderTop:"2px solid white",borderBottom:"2px solid white"}}),A.jsx("div",{className:"matrix-bracket-right",style:{position:"absolute",right:"-8px",top:"0",height:`${d*(g+p)-p}px`,width:"6px",borderRight:"2px solid white",borderTop:"2px solid white",borderBottom:"2px solid white"}}),A.jsx("div",{className:"matrix-content",children:a.map((h,y)=>A.jsx("div",{className:"matrix-row",style:{display:"flex",marginBottom:y<d-1?`${p}px`:"0"},children:h.map((v,x)=>A.jsx("div",{className:"matrix-cell",style:{width:`${g}px`,height:`${g}px`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"14px",marginRight:x<f-1?`${p}px`:"0"},children:typeof v=="number"?v.toFixed(1):v},x))},y))})]})]})},no=({children:a,delay:i=0,isVisible:l=!0})=>A.jsx(Ft.div,{initial:{opacity:0},animate:{opacity:l?1:0},transition:{delay:i,duration:.5},style:{display:"flex",alignItems:"center",gap:"20px",marginBottom:"40px"},children:a}),ao=({symbol:a})=>A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:a}),rg=({label:a,label2:i,children:l})=>A.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"5px"},children:[A.jsx("div",{style:{fontSize:"16px",color:"white",fontWeight:"bold",backgroundColor:"rgb(6, 129, 0)",border:"2px solid #22c55e",borderRadius:"8px",padding:"2px 8px"},children:a}),A.jsx("img",{src:gT,alt:"Activation Arrow",style:{width:"24px",height:"24px",filter:"invert(1)"}}),A.jsxs("div",{style:{fontSize:"16px",color:"white"},children:[" ",i," "]}),l]}),yT=()=>A.jsx(Ft.div,{initial:{opacity:0,scaleY:0},animate:{opacity:1,scaleY:1},transition:{duration:.8},style:{width:"5px",height:"30rem",backgroundColor:"white",margin:"0 60px",transformOrigin:"top"}}),sg=!0;function bT(){const[a,i]=Y.useState([]),[l,s]=Y.useState([]),[c,d]=Y.useState(!1),[f,g]=Y.useState(1),[p,h]=Y.useState(null),[y,v]=Y.useState(null),[x,w]=Y.useState({input:0,hidden:0,output:0,...Array.from({length:10},(V,K)=>({[`hidden${K+2}`]:0})).reduce((V,K)=>({...V,...K}),{})}),[M,D]=Y.useState([{}]),[_,B]=Y.useState({}),[X,q]=Y.useState({}),[W,P]=Y.useState({}),[F,Q]=Y.useState({}),[G,lt]=Y.useState({}),[ct,jt]=Y.useState(null),[Gt,Ne]=Y.useState({x:0,y:0}),[pe,Zt]=Y.useState(null),[k,Z]=Y.useState({}),[$,pt]=Y.useState([]),[T,H]=Y.useState([]),[I,J]=Y.useState([]),[it,gt]=Y.useState(!1),[ot,Ut]=Y.useState(!1),[Et,Be]=Y.useState(!1),[Nt,It]=Y.useState(!1),[Qt,Ct]=Y.useState([]),[et,St]=Y.useState(0),[wt,Dt]=Y.useState(!1),[ge,ie]=Y.useState(null),[Ze,xe]=Y.useState(!1),[on,Nn]=Y.useState(5),[kn,Xn]=Y.useState(!1),[ke,Se]=Y.useState(!1),[mn,Le]=Y.useState(null),[As,kl]=Y.useState(null),[_l,mi]=Y.useState(!0),[pi,Dn]=Y.useState(!1),[Mt,He]=Y.useState({});function De(V,K){let yt=-1*(on-5)/10*V;return K&&yt<0&&(yt=Math.max(0,yt)),new Promise(kt=>setTimeout(kt,V+yt))}Y.useEffect(()=>{if(!localStorage.getItem("neuralNetworkData")){xe(!0);const V=setTimeout(()=>xe(!1),6e3);return()=>clearTimeout(V)}},[]),Y.useEffect(()=>{const V=K=>{K.key==="`"&&Xn(st=>!st)};return window.addEventListener("keydown",V),()=>{window.removeEventListener("keydown",V)}},[]);const Xa=Y.useRef(null),Je=30,po=400;let Yn=[];const jl=()=>{fT(M,Qe,Pe,Ee,G,_,X,W,F,V=>{Yn=V.predictions,pt(V.predictions),H(V.truthValues),J(V.losses),gt(V.showResults)})},Vl=async()=>{if(Pe.length===0)return;Ut(!0),gt(!1),await De(500),Dn(!0);const V=M.filter(rt=>{const $t=Qe.some(We=>rt[We.label]&&rt[We.label].trim()!==""),Jt=rt.Truth!==void 0&&rt.Truth!=="";return $t&&Jt});if(V.length===0){alert("Please add input data with truth values"),Ut(!1),Dn(!1);return}const K=V.map(rt=>Qe.map($t=>parseFloat(rt[$t.label])||0)),st=Qe.map(rt=>Pe.map($t=>{const Jt=G[rt.label]||rt.label,We=G[$t.label]||$t.label;return _[`${Jt}-${We}`]||0})),yt=Pe.map(rt=>{const $t=G[rt.label]||rt.label;return X[$t]||0}),kt=Array(K.length).fill(yt),dt=K.map(rt=>st[0].map(($t,Jt)=>rt.reduce((We,pa,Ga)=>We+pa*st[Ga][Jt],0))),Tt=dt.map(rt=>rt.map(($t,Jt)=>$t+yt[Jt])),Bt=Tt.map(rt=>rt.map($t=>Math.max(0,$t)));let te,we,fe,ma,bo,Ya;const bi=Ee.length>0;bi&&(te=Pe.map(rt=>Ee.map($t=>{const Jt=G[rt.label]||rt.label,We=G[$t.label]||$t.label;return W[`${Jt}-${We}`]||0})),we=Ee.map(rt=>{const $t=G[rt.label]||rt.label;return F[$t]||0}),fe=Array(Bt.length).fill(we),ma=Bt.map(rt=>te[0].map(($t,Jt)=>rt.reduce((We,pa,Ga)=>We+pa*te[Ga][Jt],0))),bo=ma.map(rt=>rt.map(($t,Jt)=>$t+we[Jt])),Ya=bo.map(rt=>rt.map($t=>1/(1+Math.exp(-$t))))),He({step:1,X:K,W1:st,b1:yt,XW1:dt,b1Matrix:kt,Z1:Tt,A1:Bt,W2:te,b2:we,b2Matrix:fe,A1W2:ma,Z2:bo,A2:Ya,hasOutputLayer:bi,showFormula:!1,showXW1:!1,showZ1:!1,showReLU:!1,showDivider:!1,showLayer2Formula:!1,showA1W2:!1,showZ2:!1,showSigmoid:!1}),await De(1e3),He(rt=>({...rt,showFormula:!0})),await De(1500),He(rt=>({...rt,showXW1:!0})),await De(1500),He(rt=>({...rt,showZ1:!0})),await De(1e3),He(rt=>({...rt,showReLU:!0})),bi&&(await De(1500),He(rt=>({...rt,showDivider:!0})),await De(1e3),He(rt=>({...rt,showLayer2Formula:!0})),await De(1500),He(rt=>({...rt,showA1W2:!0})),await De(1500),He(rt=>({...rt,showZ2:!0})),await De(1e3),He(rt=>({...rt,showSigmoid:!0})))},Ul=V=>{ke&&(i(K=>K.filter(st=>st.id!==V)),s(K=>K.filter(st=>st.fromNeuronId!==V&&st.toNeuronId!==V)),v(null),Le(null))},go=V=>{ke&&(s(K=>K.filter(st=>st.id!==V)),h(null),kl(null))},yo=async()=>{if(_l){if(Pe.length===0)return;Ut(!0),gt(!1),It(!0),St(0),Dt(!1),ie(null);const V=async K=>{const st=Pe[K];if(!st)return;const yt=l.filter(dt=>dt.toNeuronId===st.id&&Qe.some(Tt=>Tt.id===dt.fromNeuronId)).map(dt=>dt.id);Ct(dt=>Array.from(new Set([...dt,...yt]))),await De(3e3),Ct(dt=>dt.filter(Tt=>!yt.includes(Tt)));const kt=l.filter(dt=>dt.fromNeuronId===st.id&&Ee.some(Tt=>Tt.id===dt.toNeuronId)).map(dt=>dt.id);Ct(dt=>Array.from(new Set([...dt,...kt]))),await De(2e3)};for(let K=0;K<Pe.length;K++)await V(K);if(Dt(!0),await De(3e3),jl(),Ee.length>0&&Yn.length>0){const K=Ee[0],st=Yn[0].toFixed(4),yt={id:`display-${Date.now()}`,x:K.x+150,y:K.y,radius:30,label:st,type:"display"};ie(yt),i(dt=>[...dt,yt]);const kt={id:`sigmoid-connection-${Date.now()}`,fromNeuronId:K.id,toNeuronId:yt.id,fromDirection:"right",toDirection:"left",isSigmoidConnection:!0};s(dt=>[...dt,kt]),Ct(dt=>[...dt,kt.id])}await De(2e3),Ut(!1),await De(4e3,sg),Dt(!1),i(K=>K.filter(st=>st.type!=="display")),s(K=>K.filter(st=>!st.isSigmoidConnection)),Ct([]),await De(700,sg),It(!1)}else await Vl(),jl()},Bl=V=>{const{setNeuronHeaders:K,setHiddenWeights:st,setHiddenBiases:yt,setOutputWeights:kt,setOutputBiases:dt}=V;return{handleInputHeaderChange:(Tt,Bt)=>{K(te=>({...te,[Tt]:Bt}))},handleWeightChange:(Tt,Bt,te)=>{st(we=>({...we,[`${Tt}-${Bt}`]:parseFloat(te)||0}))},handleBiasChange:(Tt,Bt)=>{yt(te=>({...te,[Tt]:parseFloat(Bt)||0}))},handleOutputWeightChange:(Tt,Bt,te)=>{kt(we=>({...we,[`${Tt}-${Bt}`]:parseFloat(te)||0}))},handleOutputBiasChange:(Tt,Bt)=>{dt(te=>({...te,[Tt]:parseFloat(Bt)||0}))},handleNeuronHeaderChange:(Tt,Bt)=>{K(te=>({...te,[Tt]:Bt}))}}},{handleInputHeaderChange:Os,handleWeightChange:_n,handleBiasChange:Me,handleOutputWeightChange:qe,handleOutputBiasChange:ua,handleNeuronHeaderChange:gi}=Bl({setNeuronHeaders:lt,setHiddenWeights:B,setHiddenBiases:q,setOutputWeights:P,setOutputBiases:Q}),Ll=()=>{const V=a.filter(yt=>yt.type!=="display"),K=l.filter(yt=>!yt.isSigmoidConnection),st={inputData:M,hiddenWeights:_,hiddenBiases:X,outputWeights:W,outputBiases:F,neuronHeaders:G,neurons:V,connections:K,counters:x,timestamp:new Date().toISOString()};localStorage.setItem("neuralNetworkData",JSON.stringify(st))},Hl=()=>{xe(!1);let V=localStorage.getItem("neuralNetworkData");V||(V=lg,localStorage.setItem("neuralNetworkData",lg));try{const K=JSON.parse(V);D(K.inputData||[{}]),B(K.hiddenWeights||{}),q(K.hiddenBiases||{}),P(K.outputWeights||{}),Q(K.outputBiases||{}),lt(K.neuronHeaders||{}),K.neurons&&i(K.neurons),K.connections&&(s(K.connections),Be(!0)),K.counters&&w(K.counters)}catch(K){console.error("Error loading network data:",K)}},yi=(V,K,st)=>{if(V==="connection"&&K&&st){const yt=a.find(dt=>(G[dt.label]||dt.label)===K),kt=a.find(dt=>(G[dt.label]||dt.label)===st);if(yt&&kt){const dt=l.find(Tt=>Tt.fromNeuronId===yt.id&&Tt.toNeuronId===kt.id);h(dt?.id||null)}v(null)}else if(V==="neuron"&&K){const yt=a.find(kt=>(G[kt.label]||kt.label)===K);v(yt?.id||null),h(null)}else h(null),v(null)},Qe=a.filter(V=>V.type==="input").sort((V,K)=>V.y-K.y),Pe=a.filter(V=>V.type==="hidden").sort((V,K)=>V.y-K.y),Ee=a.filter(V=>V.type==="output").sort((V,K)=>V.y-K.y),ca=Qe.map(V=>G[V.label]||V.label),fa=Pe.map(V=>G[V.label]||V.label),da=Ee.map(V=>G[V.label]||V.label),ce=V=>{if(!Xa.current)return{x:0,y:0};const K=Xa.current.getBoundingClientRect(),st=(V.clientX-K.left)/K.width*800,yt=(V.clientY-K.top)/K.height*400;return{x:st,y:yt}},ql=(V,K,st)=>{Z(yt=>({...yt,[V]:{x:K,y:st}}))},Pl=Y.useCallback(V=>{if(ct&&Xa.current){const K=ce(V);Ne(K);let st=null,yt=1/0;a.forEach(kt=>{if(kt.id!==ct.fromNeuronId){const dt=k[kt.id]||{x:0,y:0},Tt=kt.x+dt.x,Bt=kt.y+dt.y;[{direction:"top",x:Tt,y:Bt-Je},{direction:"right",x:Tt+Je,y:Bt},{direction:"bottom",x:Tt,y:Bt+Je},{direction:"left",x:Tt-Je,y:Bt}].forEach(we=>{const fe=Math.sqrt(Math.pow(K.x-we.x,2)+Math.pow(K.y-we.y,2));fe<15&&fe<yt&&(yt=fe,st={neuronId:kt.id,direction:we.direction})})}}),Zt(st)}},[ct,a,k,Je]),Gn=V=>{mT(V,x,i,w,f,po,Je)},ha=(V,K,st)=>{i(yt=>yt.map(kt=>kt.id===V?{...kt,x:K,y:st}:kt))},Ds=(V,K,st,yt,kt)=>{if(ct)if(V!==ct.fromNeuronId){const dt={id:`connection-${Date.now()}`,fromNeuronId:ct.fromNeuronId,toNeuronId:V,fromDirection:ct.fromDirection,toDirection:K};s(Tt=>[...Tt,dt]),jt(null),Zt(null)}else jt(null),Zt(null);else{const dt=a.find(ma=>ma.id===V),Tt=k[V]||{x:0,y:0},Bt=dt.x+Tt.x,te=dt.y+Tt.y,we={top:{x:Bt,y:te-Je},right:{x:Bt+Je,y:te},bottom:{x:Bt,y:te+Je},left:{x:Bt-Je,y:te}},fe=ce(kt);jt({fromNeuronId:V,fromDirection:K,startX:we[K].x,startY:we[K].y}),Ne(fe)}},Xl=()=>{pT(a,s,Be)},Yl=V=>{V.target.classList.contains("network-svg")&&ct&&(jt(null),Zt(null))},Gl=(V,K,st=()=>Gn(V),yt=0)=>A.jsx(Ft.button,{onClick:st,className:"spawn-btn",whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},initial:{opacity:0,y:20-yt},animate:{opacity:1,y:-25},transition:{delay:.1,duration:.1},children:K},V);return A.jsxs("div",{className:"app-container",children:[A.jsxs("div",{style:{position:"fixed",top:0,left:10,zIndex:100,background:"transparent",padding:"18px 24px 0 24px",color:"white",fontSize:"1rem",letterSpacing:"0.04em"},children:[A.jsx("a",{href:"../matrix_tool/",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"Home"}),A.jsx("a",{href:"https://www.linkedin.com/in/laish-glenberg/",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"About"}),A.jsx("a",{href:"https://ko-fi.com/weadsy",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"Donate"})]}),A.jsxs(Ft.div,{className:"content-wrapper-with-tables",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{duration:1,ease:"easeOut"},children:[A.jsxs("div",{className:"left-panel",children:[A.jsx(ig,{title:"Input Col Vectors",neurons:Qe,data:M,setData:D,onHeaderChange:Os,onCellHover:yi,isOutput:!1}),ot&&A.jsx("div",{style:{minHeight:"300px",display:"flex",alignItems:"center",justifyContent:"center",width:"100%"},children:A.jsx(tg,{color:["#7e7e7e","#979797","#b1b1b1","#cacaca"]})}),it&&!ot&&A.jsx(Ft.div,{initial:{opacity:0,y:30,scale:.95},animate:{opacity:1,y:0,scale:1},transition:{duration:.7,ease:"easeOut"},children:A.jsx(ig,{title:"Final Predictions",neurons:[],data:[],setData:()=>{},onHeaderChange:()=>{},onCellHover:()=>{},isOutput:!0,truthValues:T,predictions:$,losses:I})})]}),A.jsxs("div",{className:"center-panel",children:[A.jsxs("div",{className:"main-title-row",style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",marginBottom:"5px",position:"relative"},children:[A.jsx(Ft.h1,{className:"main-title",initial:{opacity:0,y:-30},animate:{opacity:1,y:10},transition:{delay:.3,duration:.8},style:{margin:0},children:"Neural Network Builder"}),A.jsxs("div",{className:"save-load-buttons",style:{position:"absolute",right:0,top:"50%",transform:"translateY(-50%)"},children:[A.jsx("button",{className:"save-load-btn",title:"Save all table values in cookies",onClick:Ll,style:{marginRight:"8px"},children:"Save"}),A.jsx("button",{className:`save-load-btn${Ze?" flash":""}`,title:"Load tables from cookies",onClick:Hl,children:"Load"})]})]}),A.jsx("div",{className:"eraser-checkbox-wrapper",style:{position:"absolute",right:"420px",top:"110px",zIndex:10},children:A.jsxs("label",{className:"eraser-checkbox-container",style:{border:"2px solid rgba(255, 255, 255, 0.3)",borderRadius:"8px",padding:"0.5rem"},children:[A.jsx("input",{type:"checkbox",checked:ke,onChange:V=>Se(V.target.checked),className:"eraser-checkbox"}),A.jsx("span",{className:"eraser-label",children:"Eraser"})]})}),A.jsx("div",{className:"eraser-checkbox-wrapper",style:{position:"absolute",right:"420px",top:"170px",zIndex:10},children:A.jsxs("label",{className:"speedbox-container",style:{border:"2px solid rgba(255, 255, 255, 0.3)",borderRadius:"8px",padding:"0.7rem 0.5rem",display:"flex",alignItems:"center",gap:"0.5rem",marginRight:"12px"},children:[A.jsx("input",{type:"number",min:0,max:kn?20:9,step:1,value:on,onChange:V=>Nn(Number(V.target.value)),className:"eraser-checkbox ishovered",style:{width:"38px",background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",borderRadius:"4px",fontSize:"1rem",padding:"2px 6px",minHeight:"25px"}}),A.jsx("span",{className:"eraser-label",children:"Speed"})]})}),a.some(V=>V.type==="output")&&a.some(V=>V.type==="input")&&a.some(V=>V.type==="hidden")&&A.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"10px",marginTop:"10px"},children:[A.jsxs("label",{className:"checkbox-container",style:{display:"flex",alignItems:"center",gap:"8px",color:"white",fontSize:"14px"},children:[A.jsx("input",{type:"checkbox",checked:_l,onChange:V=>mi(V.target.checked),style:{transform:"scale(1.2)",accentColor:"#ffffff"}}),"Learning Mode"]}),A.jsx(Ft.button,{onClick:yo,className:`spawn-btn${Et?"":" btn-disabled"}`,style:{fontSize:"16px",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"center",whiteSpace:"nowrap",opacity:ot?.5:1,cursor:ot?"not-allowed":"pointer"},disabled:!Et||ot,whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.1,duration:.1},children:ot?A.jsx(tg,{color:"#ffffff",size:"small"}):A.jsxs(A.Fragment,{children:["START",A.jsx("img",{src:BS,alt:"Train",style:{marginLeft:"10px",width:22,height:22,filter:"invert(1)",transform:"scaleX(-1)"}})]})})]}),A.jsx(ey,{children:pi&&A.jsx(Ft.div,{className:"matrix-calculations-overlay",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:.1,duration:1},style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",backgroundColor:"rgba(0, 0, 0, 0.95)",zIndex:1e3,overflow:"hidden",padding:"50px",fontFamily:"monospace"},children:Mt.step>=1&&A.jsxs("div",{style:{display:"flex",flexDirection:"row",gap:"20px",marginLeft:"80px"},children:[A.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:[Mt.showFormula&&A.jsxs(no,{delay:0,isVisible:!0,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z1 ="}),A.jsx(nn,{matrix:Mt.X,label:"X"}),A.jsx(ao,{symbol:"×"}),A.jsx(nn,{matrix:Mt.W1,label:"W1"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:[Mt.b1],label:"b1",image:A.jsx("img",{src:eg,alt:"Activation Arrow",style:{transform:"scaleX(1.27)",height:"20px",filter:"invert(1)"}})})]}),Mt.showXW1&&A.jsxs(no,{delay:0,isVisible:!0,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z1 ="}),A.jsx(nn,{matrix:Mt.XW1,label:"X * W1"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:Mt.b1Matrix,label:"b1"})]}),Mt.showZ1&&A.jsxs(no,{delay:0,isVisible:!0,children:[A.jsxs(Ft.div,{initial:{x:Mt.showReLU?-25:0},animate:{x:Mt.showReLU?-25:0},transition:{duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z1 ="}),A.jsx(nn,{matrix:Mt.Z1,label:"X * W1 + b1"})]}),Mt.showReLU&&A.jsxs(Ft.div,{initial:{opacity:0,x:50},animate:{opacity:1,x:0},transition:{delay:.5,duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx(rg,{label:"ReLU",label2:"max(0,Z1)"}),A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"A1 ="}),A.jsx(nn,{matrix:Mt.A1,label:"ReLU(Z1)"})]})]})]}),Mt.showDivider&&Mt.hasOutputLayer&&A.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center"},children:[A.jsx(yT,{}),Mt.showSigmoid&&A.jsx(Ft.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:1,duration:.5},style:{marginTop:"40px",display:"flex",justifyContent:"center",alignItems:"center",width:"100%"},children:A.jsx(Ft.button,{onClick:()=>{Dn(!1),gt(!0),Ut(!1)},className:"spawn-btn",whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},style:{fontSize:"16px",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"center",whiteSpace:"nowrap"},children:"Continue"})})]}),Mt.hasOutputLayer&&A.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:[Mt.showLayer2Formula&&A.jsxs(no,{delay:0,isVisible:!0,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z2 ="}),A.jsx(nn,{matrix:Mt.A1,label:"A1"}),A.jsx(ao,{symbol:"×"}),A.jsx(nn,{matrix:Mt.W2,label:"W2"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:[Mt.b2],label:"b2",image:A.jsx("img",{src:eg,alt:"Activation Arrow",style:{transform:"scaleX(1.27)",height:"20px",filter:"invert(1)"}})})]}),Mt.showA1W2&&A.jsxs(no,{delay:0,isVisible:!0,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z2 ="}),A.jsx(nn,{matrix:Mt.A1W2,label:"A1 * W2"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:Mt.b2Matrix,label:"b2"})]}),Mt.showZ2&&A.jsxs(no,{delay:0,isVisible:!0,children:[A.jsxs(Ft.div,{initial:{x:Mt.showSigmoid?-25:0},animate:{x:Mt.showSigmoid?-25:0},transition:{duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z2 ="}),A.jsx(nn,{matrix:Mt.Z2,label:"A1 * W2 + b2"})]}),Mt.showSigmoid&&A.jsxs(Ft.div,{initial:{opacity:0,x:50},animate:{opacity:1,x:0},transition:{delay:.5,duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx(rg,{label:"Sigmoid",children:A.jsx("svg",{width:"80",height:"40",style:{display:"block"},children:A.jsx(Xy,{x:40,y:20,sumText:"x"})})}),A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"ŷ ="}),A.jsx(nn,{matrix:Mt.A2,label:"σ(Z2)"})]})]})]})]})})}),A.jsxs(Ft.svg,{ref:Xa,width:"100%",height:"400",viewBox:"0 0 800 400",className:"network-svg",initial:{opacity:0},animate:{opacity:1},transition:{delay:.6,duration:1},onMouseMove:Pl,onClick:Yl,style:{cursor:ke?"crosshair":"default"},children:[A.jsx("defs",{children:A.jsx("marker",{id:"arrowhead",markerWidth:"10",markerHeight:"7",refX:"9",refY:"3.5",orient:"auto",children:A.jsx("polygon",{points:"0 0, 10 3.5, 0 7",className:"arrow-marker"})})}),l.map(V=>A.jsx(oT,{connection:V,neurons:a,neuronRadius:Je,neuronTransforms:k,isGlowing:p===V.id,emphasizedConnections:Qt,showForwardPassVisuals:Nt,inputData:M,currentSampleIndex:et,neuronHeaders:G,hiddenWeights:_,inputNeurons:Qe,hiddenNeurons:Pe,hiddenBiases:X,outputWeights:W,outputBiases:F,showSigmoidPhase:wt,outputNeurons:Ee,isEraserMode:ke,onEraseConnection:go,eraserHoveredConnection:As,setEraserHoveredConnection:kl},V.id)),ct&&A.jsx(iT,{startX:ct.startX,startY:ct.startY,endX:Gt.x,endY:Gt.y}),a.map(V=>A.jsx(rT,{id:V.id,x:V.x,y:V.y,radius:V.radius,label:V.label,type:V.type,onDragEnd:ha,onDragUpdate:ql,onStartConnection:Ds,highlightedDots:pe?.neuronId===V.id?[pe.direction]:[],isGlowing:y===V.id,neurons:a,showForwardPassVisuals:Nt,emphasizedConnections:Qt,hiddenNeurons:Pe,inputNeurons:Qe,outputNeurons:Ee,neuronHeaders:G,hiddenWeights:_,outputWeights:W,inputData:M,currentSampleIndex:et,hiddenBiases:X,connections:l,showSigmoidPhase:wt,outputBiases:F,isEraserMode:ke,onEraseNeuron:Ul,eraserHoveredNeuron:mn,setEraserHoveredNeuron:Le},V.id))]}),A.jsxs("div",{className:"button-stack",children:[A.jsx("div",{className:"button-dense",children:a.some(V=>V.type==="input")&&a.some(V=>V.type==="hidden")&&Gl("dense","Dense Connect",Xl)}),A.jsx("div",{className:"button-container",children:[{type:"input",label:"Add Input"},{type:"hidden",label:"Add Hidden"},...c?Array.from({length:f-1},(V,K)=>({type:`hidden${K+2}`,label:`Add Hidden ${K+2}`})):[],{type:"output",label:"Add Output"}].map(({type:V,label:K})=>Gl(V,K))})]})]}),A.jsxs("div",{className:"right-panel",children:[A.jsx(og,{title:"Hidden Layer Weights",inputLabels:ca,neuronLabels:fa,weights:_,biases:X,onWeightChange:_n,onBiasChange:Me,onHeaderChange:gi,showSaveLoad:!0,onSave:Ll,onLoad:Hl,onCellHover:yi,biasLabel:"b1"}),Pe.length>0&&Ee.length>0&&A.jsx(og,{title:"Output Layer Weights",inputLabels:fa,neuronLabels:da,weights:W,biases:F,onWeightChange:qe,onBiasChange:ua,onHeaderChange:gi,showSaveLoad:!1,onCellHover:yi,biasLabel:"b2"})]})]})]})}i1.createRoot(document.getElementById("root")).render(A.jsx(Y.StrictMode,{children:A.jsx(bT,{})}));
